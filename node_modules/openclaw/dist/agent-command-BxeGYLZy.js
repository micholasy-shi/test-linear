...
import { _ as listAgentIds, b as resolveAgentDir, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, u as resolveEffectiveModelFallbacks, x as resolveAgentWorkspaceDir } from "./agent-scope-i10se9ty.js";
import { d as readConfigFileSnapshotForWrite, i as getRuntimeConfig } from "./io-CFdEhZuM.js";
...
import { f as resolveMessageChannel } from "./message-channel-B32dwK-Q.js";
...
import { b as parseModelRef, f as resolveConfiguredModelRef, v as modelKey, y as normalizeModelRef } from "./model-selection-shared-VQV3de71.js";
...
import { o as normalizeAccountId } from "./delivery-context.shared-Bmv0a_G3.js";
import { i as emitAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-1--MOtpo.js";
import { l as ensureAgentWorkspace } from "./workspace-Ddypv-c6.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback } from "./model-fallback-Bo9VOdZK.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-Cj5-iVXn.js";
...
import { t as AGENT_LANE_SUBAGENT } from "./lanes-DvBcQ6gQ.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DEUZP4Cb.js";
import { n as normalizeSpawnedRunMetadata } from "./spawned-context-DkHh1Ku-.js";
import { r as resolveSession } from "./live-model-switch-Pt5pFOfL.js";
...
import { n as applyVerboseOverride } from "./level-overrides-B3WAixKM.js";
import { i as resolveInternalEventTranscriptBody, n as prependInternalEventContext, r as resolveAcpPromptBody, t as persistSessionEntry$1 } from "./attempt-execution.shared-Ddg0QXVr.js";
...
async function resolveAgentRuntimeConfig(runtime, params) {
	...
	}) ? (await (await import("./command-config-resolution.runtime-DPh4y48N.js")).resolveCommandConfigWithSecrets({
		config: loadedRaw,
		commandName: "agent",
...
function loadAttemptExecutionRuntime() {
	attemptExecutionRuntimePromise ??= import("./attempt-execution.runtime-Bt-E0KvB.js");
	return attemptExecutionRuntimePromise;
}
function loadAcpManagerRuntime() {
	acpManagerRuntimePromise ??= import("./manager-DfBcKcvl.js");
	return acpManagerRuntimePromise;
}
function loadAcpPolicyRuntime() {
	acpPolicyRuntimePromise ??= import("./policy-DMSglDmZ.js");
	return acpPolicyRuntimePromise;
}
function loadAcpRuntimeErrorsRuntime() {
	acpRuntimeErrorsRuntimePromise ??= import("./errors-j6i2Br_M.js");
	return acpRuntimeErrorsRuntimePromise;
}
function loadAcpSessionIdentifiersRuntime() {
	acpSessionIdentifiersRuntimePromise ??= import("./session-identifiers-CTpCvZK-.js");
	return acpSessionIdentifiersRuntimePromise;
}
function loadDeliveryRuntime() {
	deliveryRuntimePromise ??= import("./delivery.runtime-9CfvvEck.js");
	return deliveryRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./session-store.runtime-BpKe-BUD.js");
	return sessionStoreRuntimePromise;
}
function loadCliCompactionRuntime() {
	cliCompactionRuntimePromise ??= import("./cli-compaction-DyBlXmnI.js");
	return cliCompactionRuntimePromise;
}
function loadTranscriptResolveRuntime() {
	transcriptResolveRuntimePromise ??= import("./transcript-resolve.runtime-BEhGLiap.js");
	return transcriptResolveRuntimePromise;
}
function loadCliDepsRuntime() {
	cliDepsRuntimePromise ??= import("./deps-CA-OBSX9.js");
	return cliDepsRuntimePromise;
}
function loadExecDefaultsRuntime() {
	execDefaultsRuntimePromise ??= import("./exec-defaults-D_qLy6ol.js");
	return execDefaultsRuntimePromise;
}
function loadSkillsRuntime() {
	skillsRuntimePromise ??= import("./skills-DZ1H6DgZ.js");
	return skillsRuntimePromise;
}
function loadSkillsFilterRuntime() {
	skillsFilterRuntimePromise ??= import("./filter-CPtDIj8Z.js");
	return skillsFilterRuntimePromise;
}
function loadSkillsRefreshStateRuntime() {
	skillsRefreshStateRuntimePromise ??= import("./refresh-state-CwaHy0ju.js");
	return skillsRefreshStateRuntimePromise;
}
function loadSkillsRemoteRuntime() {
	skillsRemoteRuntimePromise ??= import("./skills-remote-C2OkichO.js");
...
async function prepareAgentCommandExecution(opts, runtime) {
	...
	return {
		body: acpResolution?.kind === "ready" ? resolveAcpPromptBody(message, opts.internalEvents) : prependInternalEventContext(message, opts.internalEvents),
	...
	try {
		...
		if (!resolvedThinkLevel) {
			...
			resolvedThinkLevel = resolveThinkingDefault({
				...
				provider,
				model,
				catalog: catalogForThinking.length > 0 ? catalogForThinking : void 0
			});
		}
		const catalogForThinking = modelCatalog ?? allowedModelCatalog;
