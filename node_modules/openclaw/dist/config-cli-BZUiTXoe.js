...
import { a as coerceSecretRef, c as isValidEnvSecretRefId, p as resolveSecretInputRef } from "./types.secrets-ClP-vJ-P.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-DYUJg6ZQ.js";
import { t as isBlockedObjectKey } from "./prototype-keys-DneRHviA.js";
import { n as info, o as success, t as danger } from "./globals-CJu56k75.js";
import { a as resolveSecretRefValue } from "./resolve-D64b2k8P.js";
import { w as SecretProviderSchema } from "./zod-schema.core-Dkd4NgDa.js";
import { C as collectUnsupportedSecretRefPolicyIssues, T as validateConfigObjectRaw, u as readConfigFileSnapshot } from "./io-CFdEhZuM.js";
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-B9sk7_KR.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-CXOZCJsR.js");
