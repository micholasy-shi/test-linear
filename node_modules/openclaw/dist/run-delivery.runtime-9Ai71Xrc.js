...
import { a as isSilentReplyText, c as stripSilentToken, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-D3yEVrkk.js";
...
import { a as hasReplyPayloadContent } from "./payload-Can1Co80.js";
import { n as pickLastNonEmptyTextFromPayloads, r as pickSummaryFromOutput } from "./helpers-gjf6tglW.js";
import { _ as resolveDeliveryTarget, l as hasScheduledNextRunAtMs } from "./jobs-DVfujmeJ.js";
import { t as createCronExecutionId } from "./run-id-Dp688XYI.js";
import { n as isLikelyInterimCronMessage, t as expectsSubagentFollowup } from "./subagent-followup-hints-BdepinMK.js";
...
async function loadGatewayCallRuntime() {
	gatewayCallRuntimePromise ??= import("./call.runtime-B_QvydKF.js");
	return await gatewayCallRuntimePromise;
}
async function loadDeliveryOutboundRuntime() {
	deliveryOutboundRuntimePromise ??= import("./delivery-outbound.runtime-7bn-VeH3.js");
	return await deliveryOutboundRuntimePromise;
}
async function loadDeliverySubagentRegistryRuntime() {
	deliverySubagentRegistryRuntimePromise ??= import("./delivery-subagent-registry.runtime-1n9TcGML.js");
	return await deliverySubagentRegistryRuntimePromise;
}
async function loadDeliveryLoggerRuntime() {
	deliveryLoggerRuntimePromise ??= import("./delivery-logger.runtime-CNYjCNJN.js");
	return await deliveryLoggerRuntimePromise;
}
async function loadSubagentFollowupRuntime() {
	subagentFollowupRuntimePromise ??= import("./subagent-followup.runtime-BCO1WAsg.js");
