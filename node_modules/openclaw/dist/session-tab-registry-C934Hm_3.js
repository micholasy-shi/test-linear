...
import "./net-DQD-XJLi.js";
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-YcwCRQxx.js";
import { h as resolveBrowserRateLimitMessage } from "./cdp.helpers-BROBy6Ra.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-nPoiVzRi.js");
