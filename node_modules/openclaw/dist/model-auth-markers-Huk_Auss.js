...
import { a as resolveProviderAuthEnvVarCandidates, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-COSpaRlD.js";
...
function listKnownNonSecretApiKeyMarkers() {
	knownNonSecretApiKeyMarkersCache ??= [...new Set([...CORE_NON_SECRET_API_KEY_MARKERS, ...loadPluginManifestRegistryForPluginRegistry({ includeDisabled: true }).plugins.flatMap((plugin) => plugin.origin === "bundled" ? plugin.nonSecretAuthMarkers ?? [] : [])])];
