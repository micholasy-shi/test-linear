...
import { t as logDebug } from "./logger-mz_TsqXj.js";
import { c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-naHBWFyS.js";
import { n as normalizeAccountId } from "./account-id-DhSD7lhD.js";
import { c as normalizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-hxP9B3Or.js";
import { g as listAgentEntries, m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-i10se9ty.js";
...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-CFdEhZuM.js";
import { r as normalizeProviderId } from "./provider-id-DRW5WMbW.js";
import { n as loadPluginManifestRegistryForPluginRegistry, o as resolveManifestContractOwnerPluginId } from "./plugin-registry-CZ8QXP5l.js";
...
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-yTN80EXi.js";
import { t as isWindowsDrivePath } from "./archive-path-CUvFJ-L4.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-CYYfKgf3.js";
import { t as applyMergePatch } from "./merge-patch-CGxsvYoX.js";
import { g as selectApplicableRuntimeConfig } from "./runtime-snapshot-DLisEE8Y.js";
...
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-topex1pR.js";
import { u as normalizeMessageChannel } from "./message-channel-B32dwK-Q.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-B6EKzVSa.js";
import { l as scheduleGatewaySigusr1Restart } from "./restart-BEJNVwEm.js";
import { n as resolveBundledPluginCompatibleLoadValues } from "./activation-context-BoOFvRID.js";
import "./plugins-D-K4uCVI.js";
import { b as normalizeProviderTransportWithPlugin } from "./provider-runtime-CwkNkui5.js";
import { n as ensureOpenClawModelsJson } from "./models-config-Bv7OnXdx.js";
import { h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, v as modelKey, y as normalizeModelRef } from "./model-selection-shared-VQV3de71.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-GlsOqTDm.js";
...
import { r as loadModelCatalog } from "./model-catalog-iwhpeFqc.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-CsMq3g6_.js";
import { a as normalizeMediaProviderId, t as matchesMediaEntryCapability } from "./entry-capabilities-9IOuU153.js";
import { b as resolveAutoMediaKeyProviders, g as DEFAULT_TIMEOUT_SECONDS, s as resolveTimeoutMs, w as getMediaUnderstandingProvider, x as resolveDefaultMediaModel, y as providerSupportsNativePdfDocument } from "./resolve-D7aTN-e2.js";
...
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-C8kEtINy.js";
import { a as getImageMetadata } from "./image-ops-B5o_jjbN.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-B-vvNIo6.js";
import { t as extractPdfContent } from "./pdf-extract-BOFG3aX6.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-pawJlK6I.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-rBYenfpu.js";
import { t as buildProviderRegistry } from "./runner-DO4b0WOz.js";
import { A as describeSessionsHistoryTool, C as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, D as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, E as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, M as describeSessionsSendTool, N as describeSessionsSpawnTool, O as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, P as describeUpdatePlanTool, S as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, T as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, j as describeSessionsListTool, k as describeSessionStatusTool, w as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, y as CRON_TOOL_DISPLAY_SUMMARY } from "./tool-policy-CC72sL8W.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-BvdjNS1u.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-CHP3g1Fg.js";
...
import { n as resolveSessionConversationRef } from "./session-conversation-CdbBzqqi.js";
import { h as jsonUtf8Bytes, n as capArrayByJsonBytes, o as readSessionTitleFieldsFromTranscript } from "./session-utils.fs-BgGqlqA-.js";
import { f as resolveSessionModelIdentityRef, t as deriveSessionTitle } from "./session-utils-r05OsxB5.js";
...
import { D as textToSpeech } from "./tts-runtime-B_NCSUbj.js";
import "./tts-DGauou57.js";
import { p as extractTextFromChatContent } from "./sanitize-user-facing-text-DgEphtot.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-gG8dJ_Bm.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-BXJT49qh.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-46H5gILp.js";
import { r as getApiKeyForModel } from "./model-auth-Bic7ggHC.js";
import { u as parseReplyDirectives } from "./payloads-Br5VEYXq.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-Ntlu467h.js";
import { n as runWithImageModelFallback } from "./model-fallback-Bo9VOdZK.js";
import { n as extractAssistantText } from "./pi-embedded-utils-BQKVwAP4.js";
import { r as callGateway } from "./call-CP7A3sdw.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-C4RGIxnG.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-DY8i5DmM.js";
import { n as assertSandboxPath } from "./sandbox-paths-BdrQ0pdY.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-DbORTzDx.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-BHvI5I0v.js";
import "./delivery-context-DVl8q3EW.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-DO-Zcf_d.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-psXDucI-.js";
...
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-Dpv8k6Hg.js";
import { r as stripToolMessages } from "./chat-history-text-x1S2bCxx.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-m6SQmHwa.js";
...
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-1XVo5mVb.js";
import { t as normalizeHttpWebhookUrl } from "./webhook-url-BcYN1Hdt.js";
...
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-tTeGmzRv.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-Biqw4jE7.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-DyZ75cuV.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-dPMAftYg.js";
import { l as saveMediaBuffer } from "./store-L0fSpY73.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-B_U8JJxq.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-9UYLzIiN.js";
import { a as coerceImageModelConfig, c as resolveProviderVisionModelFromConfig, d as hasAuthForProvider, f as hasToolModelConfig, l as buildToolModelConfigFromCandidates, n as isMinimaxVlmProvider, o as decodeDataUrl, p as resolveDefaultModelRef, u as coerceToolModelConfig } from "./minimax-vlm-DLINyOpl.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-Db6VtIqj.js";
import "./media-understanding-BkzEkGaw.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-OfE7WYlj.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-Bz9ocmUm.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-Cj5-iVXn.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-CkqyWfJZ.js";
import { t as sendMessage } from "./message-TWvwGNzX.js";
import { i as resolveMusicGenerationModeCapabilities, n as listRuntimeMusicGenerationProviders, r as listSupportedMusicGenerationModes, t as generateMusic } from "./runtime-IZRdPiOh.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-0DPNvGlh.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-B_agTNy0.js";
...
import { i as failTaskRunByRunId, o as recordTaskRunProgressByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-6WfuNV0D.js";
import "./task-registry-delivery-runtime-CRYRbeRv.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-Bmaafn-Q.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-DtV7FLLR.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-BTHqePMo.js";
import { t as parseTimeoutMs } from "./parse-timeout-KACUMoby.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DF4_v-G4.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-D8uN2rND.js";
import { n as isRequesterParentOfBackgroundAcpSession } from "./session-interaction-mode-dWRM_6kV.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-DvBcQ6gQ.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, n as readLatestAssistantReply, r as readLatestAssistantReplySnapshot } from "./run-wait-DILT26j3.js";
import { d as runAgentStep, f as ANNOUNCE_SKIP_TOKEN, h as isReplySkip, m as isAnnounceSkip, p as REPLY_SKIP_TOKEN } from "./subagent-announce-output-V8Qd-Aa3.js";
import { p as registerSubagentRun } from "./subagent-registry-DopJgK6v.js";
import { n as SUBAGENT_SPAWN_CONTEXT_MODES, r as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn--QfZonyO.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-CVV3q_5a.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-DT27LrWV.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime--0cMos2d.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-CMph2Xi6.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-DPgiJEIj.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-DVK8VCi6.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-60FKu8ja.js";
import { a as runWebSearch, i as resolveWebSearchDefinition } from "./runtime-Cngcq-4j.js";
import "./web-search-provider-common-CGGdeSyq.js";
...
function resolveAgentRuntimeMetadata(cfg, agentId) {
	const envRuntime = normalizeRuntimeValue(process.env.OPENCLAW_AGENT_RUNTIME);
	if (envRuntime) return {
		id: envRuntime,
		source: "env"
	};
	const agentPolicy = resolveAgentRuntimePolicy(listAgentEntries(cfg).find((entry) => normalizeAgentId(entry.id) === agentId));
...
async function getRuntime() {
	if (!runtimeMod) runtimeMod = await import("./embedded-gateway-stub.runtime-Cz7_SdPn.js");
	return runtimeMod;
}
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-C4FP4vTn.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-D5hapBLr.js");
...
async function loadWebFetchRuntime() {
	webFetchRuntimePromise ??= import("./runtime-CWaq3I4I.js");
	return await webFetchRuntimePromise;
}
async function loadWebGuardedFetch() {
	webGuardedFetchPromise ??= import("./web-guarded-fetch-AsEGceZf.js");
...
//#endregion
export { createSandboxedEditTool as a, wrapToolMemoryFlushAppendOnlyWrite as c, isStrictAgenticExecutionContractActive as d, isStrictAgenticSupportedProviderModel as f, setEmbeddedMode as h, createOpenClawReadTool as i, wrapToolWorkspaceRootGuard as l, isEmbeddedMode as m, createHostWorkspaceEditTool as n, createSandboxedReadTool as o, stripProviderPrefix as p, createHostWorkspaceWriteTool as r, createSandboxedWriteTool as s, createOpenClawTools as t, wrapToolWorkspaceRootGuardWithOptions as u };
