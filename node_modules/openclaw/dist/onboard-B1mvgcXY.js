...
import "./daemon-runtime-CD7VqLWH.js";
import { c as isValidEnvSecretRefId, p as resolveSecretInputRef } from "./types.secrets-ClP-vJ-P.js";
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-DYUJg6ZQ.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-D33ItfMH.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-mX5Q_dhT.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-DuzoWx5N.js";
import { t as runSetupWizard } from "./setup-Bt_9I3XO.js";
import { i as applySkipBootstrapConfig, r as applyLocalSetupWorkspaceConfig } from "./onboard-config-DaWy7Ib7.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-D0Q9NVFX.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-BgKCNEIz.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Do-ECdFP.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BCA1EK3a.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-Dn7SjhPF.js");
