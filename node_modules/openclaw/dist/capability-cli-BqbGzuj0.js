...
import { S as resolveDefaultAgentId, b as resolveAgentDir } from "./agent-scope-i10se9ty.js";
...
import { f as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-D-8DaAtv.js";
import { a as registerMemoryEmbeddingProvider, r as listMemoryEmbeddingProviders } from "./memory-embedding-providers-By8WiAeR.js";
import { r as loadModelCatalog } from "./model-catalog-iwhpeFqc.js";
import { C as buildMediaUnderstandingRegistry } from "./resolve-D7aTN-e2.js";
import { a as getImageMetadata } from "./image-ops-B5o_jjbN.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-B-vvNIo6.js";
import { D as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-B_NCSUbj.js";
...
import { c as randomIdempotencyKey, r as callGateway } from "./call-CP7A3sdw.js";
...
import { a as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-Cngcq-4j.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BkPKyCZS.js";
import { r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-C_yMfURD.js";
import { n as agentCommand } from "./agent-command-BxeGYLZy.js";
import { t as removeCommandByName } from "./command-tree-CjLL1vPq.js";
import { t as collectOption } from "./helpers-DOs6tuvR.js";
import { n as runCommandWithRuntime } from "./cli-utils-Bey8_EmD.js";
import { a as transcribeAudioFile, n as describeImageFileWithModel, r as describeVideoFile, t as describeImageFile } from "./runtime-BrvwSQRM.js";
import { t as createDefaultDeps } from "./deps-DU-zHj4u.js";
import { i as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-rDmBFpO1.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-lDUugGEC.js";
...
async function runModelRun(params) {
	const agentId = resolveDefaultAgentId(getRuntimeConfig());
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-CHsNisGK.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-D4PjSv9I.js");
