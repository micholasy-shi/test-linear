...
import { n as isAbortError } from "./unhandled-rejections-CjchfgLD.js";
...
import { a as logWarn, t as logDebug } from "./logger-mz_TsqXj.js";
import { t as runTasksWithConcurrency } from "./run-with-concurrency-CBZG2z70.js";
import "./auth-Chs4IZd-.js";
import { t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-D9vCjzKT.js";
import { a as isSubagentSessionKey, c as parseThreadSessionSuffix, n as isAcpSessionKey, o as parseAgentSessionKey } from "./session-key-utils-naHBWFyS.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-DhSD7lhD.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, o as classifySessionKeyShape, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-hxP9B3Or.js";
import { S as resolveDefaultAgentId, _ as listAgentIds, b as resolveAgentDir, g as listAgentEntries, p as resolveSessionAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-i10se9ty.js";
import { t as sameFileIdentity } from "./file-identity-DDN1fB3L.js";
import { D as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-CFdEhZuM.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-BJUjz44D.js";
...
import { i as normalizeChannelId, r as listChannelPlugins, t as getChannelPlugin } from "./registry-yTN80EXi.js";
import { r as DEFAULT_PROVIDER } from "./defaults-CRz26M83.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-DUMWf2rB.js";
import { g as writeFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-CYYfKgf3.js";
...
import { a as publicKeyRawBase64UrlFromPem, r as loadOrCreateDeviceIdentity } from "./device-identity-BnG7_kkp.js";
import { a as hasGatewayClientCap, n as GATEWAY_CLIENT_IDS, t as GATEWAY_CLIENT_CAPS } from "./client-info-B22NhLQV.js";
import "./message-channel-core-topex1pR.js";
import { c as isGatewayMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-B32dwK-Q.js";
import { $ as validateNodeDescribeParams, $t as validateTalkRealtimeSessionParams, A as validateCronListParams, At as validateSessionsDeleteParams, B as validateDeviceTokenRevokeParams, Bt as validateSkillsBinsParams, C as validateConfigPatchParams, Ct as validateSessionsAbortParams, D as validateConfigSetParams, Dt as validateSessionsCompactionListParams, E as validateConfigSchemaParams, Et as validateSessionsCompactionGetParams, F as validateCronUpdateParams, Ft as validateSessionsPreviewParams, Gt as validateSkillsUpdateParams, Ht as validateSkillsInstallParams, I as validateDevicePairApproveParams, It as validateSessionsResetParams, J as validateExecApprovalsNodeSetParams, Jt as validateTalkModeParams, K as validateExecApprovalsGetParams, Kt as validateTalkConfigParams, L as validateDevicePairListParams, Lt as validateSessionsResolveParams, M as validateCronRunParams, Mr as errorShape, Mt as validateSessionsMessagesSubscribeParams, N as validateCronRunsParams, Nt as validateSessionsMessagesUnsubscribeParams, Ot as validateSessionsCompactionRestoreParams, P as validateCronStatusParams, Pt as validateSessionsPatchParams, Q as validateModelsListParams, Qt as validateTalkRealtimeRelayToolResultParams, R as validateDevicePairRejectParams, Rt as validateSessionsSendParams, S as validateConfigGetParams, St as validateSendParams, T as validateConfigSchemaLookupResult, Tt as validateSessionsCompactionBranchParams, Ut as validateSkillsSearchParams, V as validateDeviceTokenRotateParams, Vt as validateSkillsDetailParams, Wt as validateSkillsStatusParams, X as validateLogsTailParams, Xt as validateTalkRealtimeRelayMarkParams, Y as validateExecApprovalsSetParams, Yt as validateTalkRealtimeRelayAudioParams, Z as validateMessageActionParams, Zr as COMMAND_DESCRIPTION_MAX_LENGTH, Zt as validateTalkRealtimeRelayStopParams, _n as validateWizardStatusParams, _t as validatePushTestParams, a as validateAgentsCreateParams, an as validateUpdateRunParams, at as validateNodePairListParams, b as validateCommandsListParams, c as validateAgentsFilesListParams, cn as validateWebLoginStartParams, ct as validateNodePairRequestParams, d as validateAgentsUpdateParams, dn as validateWebPushTestParams, dt as validateNodePendingDrainParams, et as validateNodeEventParams, f as validateChannelsLogoutParams, fn as validateWebPushUnsubscribeParams, ft as validateNodePendingEnqueueParams, gn as validateWizardStartParams, gt as validatePollParams, hn as validateWizardNextParams, i as validateAgentWaitParams, in as validateToolsEffectiveParams, it as validateNodePairApproveParams, j as validateCronRemoveParams, jr as ErrorCodes, jt as validateSessionsListParams, k as validateCronAddParams, kt as validateSessionsCreateParams, l as validateAgentsFilesSetParams, ln as validateWebLoginWaitParams, lt as validateNodePairVerifyParams, m as validateChannelsStatusParams, mn as validateWizardCancelParams, n as validateAgentIdentityParams, nt as validateNodeInvokeResultParams, o as validateAgentsDeleteParams, on as validateUpdateStatusParams, ot as validateNodePairRejectParams, p as validateChannelsStartParams, pn as validateWebPushVapidPublicKeyParams, pt as validateNodeRenameParams, q as validateExecApprovalsNodeGetParams, r as validateAgentParams, rn as validateToolsCatalogParams, rt as validateNodeListParams, s as validateAgentsFilesGetParams, sn as validateWakeParams, st as validateNodePairRemoveParams, t as formatValidationErrors, tn as validateTalkSpeakParams, tt as validateNodeInvokeParams, u as validateAgentsListParams, un as validateWebPushSubscribeParams, ut as validateNodePendingAckParams, w as validateConfigSchemaLookupParams, wt as validateSessionsCompactParams, x as validateConfigApplyParams, z as validateDevicePairRemoveParams, zt as validateSessionsUsageParams } from "./protocol-Hjar_s3V.js";
import { a as normalizeInputProvenance } from "./input-provenance-DhG5f54s.js";
import { n as authorizeOperatorScopesForMethod, o as ADMIN_SCOPE$1, u as TALK_SECRETS_SCOPE } from "./method-scopes-D2ZEhvQU.js";
import { n as formatConfigIssueLines } from "./issue-format-DUq-EpQO.js";
import { l as scheduleGatewaySigusr1Restart } from "./restart-BEJNVwEm.js";
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-JUcbpYyX.js";
...
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-B_EmO0tQ.js";
import "./plugins-D-K4uCVI.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-BafH2tQ8.js";
import { n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-Df1Zlb_-.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-BrfRtlzX.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-Cvhc4iGK.js";
import { f as normalizeReasoningLevel, p as normalizeThinkLevel } from "./thinking-DhTFkZJF.js";
import { t as buildAllowedModelSet } from "./model-selection-GlsOqTDm.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-xONgR3PN.js";
import { _ as listCoreToolSections, h as PROFILE_OPTIONS, v as resolveCoreToolProfiles } from "./tool-policy-CC72sL8W.js";
import { n as resolveAgentIdentity } from "./identity-CviweAtG.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-JXLAAy4Q.js";
import { n as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-IXcczRzK.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-CHP3g1Fg.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-Bmv0a_G3.js";
import { t as loadSessionStore } from "./store-load-DLuD4etm.js";
import { n as mergeSessionEntry } from "./types-UHw-opRq.js";
import { o as updateSessionStore } from "./store-CR7YmZjp.js";
import { n as resolveMainSessionKeyFromConfig, t as extractDeliveryInfo } from "./sessions-CLHVJJOI.js";
import { n as resolveSessionLifecycleTimestamps } from "./lifecycle-B32KazD3.js";
import { i as resolveSessionResetPolicy, n as evaluateSessionFreshness } from "./reset-policy-CzdetTPd.js";
import { n as resolveChannelResetConfig, r as resolveSessionResetType } from "./reset-BUTJ832C.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-1--MOtpo.js";
import { n as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-BEexMWUF.js";
import { a as readSessionPreviewItemsFromTranscript, i as readSessionMessages } from "./session-utils.fs-BgGqlqA-.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-CzArr0l-.js";
...
import { h as listSessionCompactionCheckpoints, m as getSessionCompactionCheckpoint } from "./build-DuvTWnZM.js";
import { n as getPluginToolMeta, r as resolvePluginTools } from "./tools-DHEGJXyc.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-CHwgMzic.js";
import { D as textToSpeech, E as synthesizeSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, f as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-B_NCSUbj.js";
import "./tts-DGauou57.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Ddypv-c6.js";
import { a as isTimeoutError } from "./failover-error-DQkWPkYr.js";
import "./auth-profiles-BOEvF4Rg.js";
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-Br5VEYXq.js";
import { d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, y as readExecApprovalsSnapshot } from "./exec-approvals-BzZbTLG7.js";
import { a as prepareSecretsRuntimeSnapshot } from "./runtime-BHvI5I0v.js";
import { i as parseAbsoluteTimeMs } from "./stagger-CkuPeJH1.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-BcYN1Hdt.js";
import { r as normalizeCronJobPatch, t as normalizeCronJobCreate } from "./normalize-DeXOH_O0.js";
import { i as formatDoctorNonInteractiveHint, m as writeRestartSentinel } from "./restart-sentinel-xJkrCnsf.js";
import { l as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-BLUq4AzU.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-CkqyWfJZ.js";
import { n as normalizePollInput } from "./polls-T-m992dB.js";
import { t as deliverOutboundPayloads } from "./deliver-W8vl_gyO.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-3H8LfbCi.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-CfzWknnV.js";
import "./target-resolver-7ALQauKj.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-CPSw2Ee5.js";
...
import { r as resolveOutboundTarget } from "./targets-CrrO3SQE.js";
import { t as extractToolPayload } from "./tool-payload-C5SoOvpS.js";
import { i as setHeartbeatsEnabled } from "./heartbeat-wake-FxHI2o_9.js";
import { i as enqueueSystemEvent, o as isSystemEventContextChanged } from "./system-events-BOVw40Do.js";
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime-6WfuNV0D.js";
import { a as clearSessionQueues } from "./queue-B4CxW4nn.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-CAMroMUg.js";
import { d as waitForEmbeddedPiRunEnd, i as isEmbeddedPiRunActive, t as abortEmbeddedPiRun } from "./runs-CCsjme9h.js";
import { h as normalizeDiagnosticStabilityQuery, m as getDiagnosticStabilitySnapshot } from "./diagnostic-stability-bundle-qDPYowjl.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DEUZP4Cb.js";
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-DkHh1Ku-.js";
...
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-CgVoTNyj.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-jZWW2jYw.js";
...
import { t as getChannelActivity } from "./channel-activity-Bfsq8DHc.js";
import { t as WizardCancelledError } from "./prompts-CsV4pT5z.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-DqSu21Sx.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-BUnrcBOQ.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-Bav4SIwP.js";
import { n as movePathToTrash } from "./browser-maintenance-C9Kyoyqd.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-Dev4DATw.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-D-pyOuBK.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-Cj-E-v3U.js";
import { r as agentCommandFromIngress } from "./agent-command-BxeGYLZy.js";
import { n as invokeNativeHookRelay } from "./native-hook-relay-lVu-qwVZ.js";
...
import { t as formatForLog } from "./ws-log-p1eSleCB.js";
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-BvSQb3Px.js";
...
import { _ as verifyNodeToken, d as listNodePairing, f as rejectNodePairing, h as requestNodePairing, l as approveNodePairing, m as renamePairedNode, p as removePairedNode, t as getRemoteSkillEligibility } from "./skills-remote-BrTLeqls.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-Dh4XF0y6.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-wkouYy9B.js";
import { b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, i as getRealtimeVoiceProvider, n as resolveConfiguredRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession } from "./session-runtime-DOWNBdF0.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-DbAk3IUd.js";
import { n as createOutboundSendDeps } from "./deps-DU-zHj4u.js";
import "./agent-CVA6qQoT.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-Cx_NKhFN.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-BtyF2vio.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-CXj631hF.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BaqI2sRl.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-CTjpvvH8.js";
import "./server-constants-D1hNc2O7.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController } from "./chat-abort-hPcmdsnz.js";
import { n as MediaOffloadError, r as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-Bl3b9I5G.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-C0DpoK16.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-C7nBGyPq.js";
import { t as loadProviderUsageSummary } from "./provider-usage-C86sU_2t.js";
import { o as fetchClawHubSkillDetail } from "./clawhub-CGP935vu.js";
import { a as loadSessionUsageTimeSeries, i as loadSessionLogs, n as loadCostUsageSummary, o as resolveExistingUsageSessionFile, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-BwDaKDyw.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-juR93cKY.js";
...
import { o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DLUj9AXa.js";
import { t as installSkill } from "./skills-install-DluEmgHD.js";
import { m as normalizeUpdateChannel } from "./update-check-BRY_D61t.js";
import { t as getStatusSummary } from "./status.summary-B5ptE_H8.js";
import "./status-Dok6Ui9H.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-CR-7Y-p2.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-D40GZHlu.js";
import { m as readPackageVersion, n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-Bz-TX8OW.js";
import { t as buildChannelAccountSnapshot } from "./status-CYUq2OLu.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-6uwjjBg2.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-DAylTJk0.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-DVfujmeJ.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-Oa5mWdh_.js";
import { C as isRoleAuthorizedForMethod, E as consumeControlPlaneWriteBudget, S as validateVoiceWakeRoutingConfigInput, _ as buildGatewayReloadPlan, a as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, b as resolveVoiceWakeRouteByTrigger, c as nodeWakeById, d as normalizeVoiceWakeTriggers, f as loadVoiceWakeConfig, h as resolveGatewayReloadSettings, l as nodeWakeNudgeById, m as diffConfigPaths, n as listSystemPresence, o as NODE_WAKE_RECONNECT_WAIT_MS, p as setVoiceWakeTriggers, r as updateSystemPresence, t as broadcastPresenceSnapshot, u as formatError$1, v as loadVoiceWakeRoutingConfig, w as parseGatewayRole, x as setVoiceWakeRoutingConfig, y as normalizeVoiceWakeRoutingConfig } from "./presence-events-DktTPEyC.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DATsloye.js";
import { n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-CuMcYzPG.js";
import "./heartbeat-runner-BPAToAzE.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-psrIBzaE.js";
...
async function loadSessionSubagentReactivationRuntime() {
	return import("./session-subagent-reactivation.runtime-45QRE1Vu.js");
}
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DxeveG8H.js");
...
function applyVapidDetails(keys) {
	webPush.setVapidDetails(keys.subject, keys.publicKey, keys.privateKey);
}
async function sendPreparedWebPushNotification(subscription, payload) {
...
async function broadcastWebPush(payload, baseDir) {
	...
	applyVapidDetails(await resolveVapidKeys(baseDir));
	const mapped = (await Promise.allSettled(subscriptions.map((sub) => sendPreparedWebPushNotification(sub, payload)))).map((r, i) => r.status === "fulfilled" ? r.value : {
		ok: false,
...
function loadSessionsRuntimeModule() {
	sessionsRuntimeModulePromise ??= import("./sessions.runtime-DqUeDGUp.js");
