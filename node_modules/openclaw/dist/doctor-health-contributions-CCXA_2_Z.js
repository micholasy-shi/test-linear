...
async function runGatewayConfigHealth(ctx) {
	...
	const { hasAmbiguousGatewayAuthModeConfig } = await import("./auth-mode-policy-SLuXajHo.js");
	const { note } = await import("./note-CA-1U15g.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-Cu_K2grd.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-h77CJ52R.js");
	const { buildGatewayConnectionDetails } = await import("./call-DH9e33Y7.js");
	const { note } = await import("./note-CA-1U15g.js");
...
async function runGatewayAuthHealth(ctx) {
	const { resolveSecretInputRef } = await import("./types.secrets-4I0-cmzb.js");
	const { resolveGatewayAuth } = await import("./auth-Dg2ujdYi.js");
	const { note } = await import("./note-CA-1U15g.js");
	const { randomToken } = await import("./onboard-helpers-rUrMc8dI.js");
...
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-BPzdEVS6.js");
	noteClaudeCliHealth(ctx.cfg);
}
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-KnHNg3bb.js");
	const { note } = await import("./note-CA-1U15g.js");
...
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-CW6WwLtG.js");
...
async function runPluginRegistryHealth(ctx) {
	const { maybeRepairPluginRegistryState } = await import("./doctor-plugin-registry-knBrapug.js");
...
async function runBundledPluginRuntimeDepsHealth(ctx) {
	const { maybeRepairBundledPluginRuntimeDeps } = await import("./doctor-bundled-plugin-runtime-deps-CiQxW0ig.js");
...
async function runStateIntegrityHealth(ctx) {
	const { noteStateIntegrity } = await import("./doctor-state-integrity-B5m1rpvm.js");
	await noteStateIntegrity(ctx.cfg, ctx.prompter, ctx.configPath);
}
async function runSessionLocksHealth(ctx) {
	const { noteSessionLockHealth } = await import("./doctor-session-locks-D5JEq7kJ.js");
	await noteSessionLockHealth({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runSessionTranscriptsHealth(ctx) {
	const { noteSessionTranscriptHealth } = await import("./doctor-session-transcripts-yOaCjs6i.js");
	await noteSessionTranscriptHealth({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore } = await import("./doctor-cron-DX9N7BN7.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, noteSandboxScopeWarnings } = await import("./doctor-sandbox-BOWzWRcc.js");
...
async function runGatewayServicesHealth(ctx) {
	const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-O_G0jeFK.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides } = await import("./doctor-platform-notes-B2anOMSt.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-B6QKeQvK.js");
...
async function runSecurityHealth(ctx) {
	const { noteSecurityWarnings } = await import("./doctor-security-CM3GVJtC.js");
	await noteSecurityWarnings(ctx.cfg);
}
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-C2xxcVpy.js");
	await noteChromeMcpBrowserReadiness(ctx.cfg);
}
async function runOpenAIOAuthTlsHealth(ctx) {
	const { noteOpenAIOAuthTlsPrerequisites } = await import("./oauth-tls-preflight-syjEk8q6.js");
...
async function runHooksModelHealth(ctx) {
	...
	const { DEFAULT_MODEL, DEFAULT_PROVIDER } = await import("./defaults-DIHGbLP8.js");
	const { loadModelCatalog } = await import("./model-catalog-Bb7i0Ftu.js");
	const { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel } = await import("./model-selection-CKoFzMjk.js");
	const { note } = await import("./note-CA-1U15g.js");
...
async function runSystemdLingerHealth(ctx) {
	...
	const { resolveGatewayService } = await import("./service-DbOGhulA.js");
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-hSaVH6_h.js");
	const { note } = await import("./note-CA-1U15g.js");
...
async function runWorkspaceStatusHealth(ctx) {
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-BuBsxaTm.js");
	noteWorkspaceStatus(ctx.cfg);
}
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-DNXW2cvb.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-guh4tVMw.js");
...
async function runGatewayHealthChecks(ctx) {
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-BGZZt32_.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-DA8TSpcF.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-G0mMzSmp.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-BJRWGNB5.js");
...
async function runWriteConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-BL3wkhq1.js");
	const { applyWizardMetadata } = await import("./onboard-helpers-rUrMc8dI.js");
	const { CONFIG_PATH, replaceConfigFile } = await import("./config/config.js");
	const { logConfigUpdated } = await import("./logging-QYz7baDe.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-CGzrSsdb.js");
	const { noteWorkspaceBackupTip } = await import("./doctor-state-integrity-B5m1rpvm.js");
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-DLRurNwK.js");
	const { note } = await import("./note-CA-1U15g.js");
