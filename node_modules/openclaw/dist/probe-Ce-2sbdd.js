...
import { n as GatewayClientRequestError, o as loadDeviceAuthToken, t as GatewayClient } from "./client-Dh94CUDv.js";
...
import { l as READ_SCOPE } from "./method-scopes-D2ZEhvQU.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		...
		try {
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-BmNICyBJ.js");
