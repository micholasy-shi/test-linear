import{h as e,o as t,p as n}from"./string-coerce-C4mH-Yei.js";import{i as r}from"./index-DV4QBOU4.js";function i(i){let a=(i.status&&typeof i.status==`object`?i.status.securityAudit:null)?.summary??null,o=a?.critical??0,s=a?.warn??0,c=a?.info??0,l=o>0?`danger`:s>0?`warn`:`success`,u=o>0?`${o} critical`:s>0?`${s} warnings`:`No critical issues`;return e`
    <section class="grid">
      <div class="card">
...
//# sourceMappingURL=debug-EaUBCuTs.js.map