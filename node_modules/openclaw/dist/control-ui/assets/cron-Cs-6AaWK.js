import{h as e,o as t,p as n}from"./string-coerce-C4mH-Yei.js";import{L as r,N as i,a,d as o,n as s,p as c,z as l}from"./index-DV4QBOU4.js";var u=e=>e??n;function d(){return[{value:`ok`,label:t(`cron.runs.runStatusOk`)},{value:`error`,label:t(`cron.runs.runStatusError`)},{value:`skipped`,label:t(`cron.runs.runStatusSkipped`)}]}function f(){return[{value:`delivered`,label:t(`cron.runs.deliveryDelivered`)},{value:`not-delivered`,label:t(`cron.runs.deliveryNotDelivered`)},{value:`unknown`,label:t(`cron.runs.deliveryUnknown`)},{value:`not-requested`,label:t(`cron.runs.deliveryNotRequested`)}]}function p(e,t,n){let r=new Set(e);return n?r.add(t):r.delete(t),Array.from(r)}function m(e,t){return e.length===0?t:e.length<=2?e.join(`, `):`${e[0]} +${e.length-1}`}function h(e){let t=[`last`,...e.channels.filter(Boolean)],n=e.form.deliveryChannel?.trim();n&&!t.includes(n)&&t.push(n);let r=new Set;return t.filter(e=>r.has(e)?!1:(r.add(e),!0))}function g(e,t){if(t===`last`)return`last`;let n=e.channelMeta?.find(e=>e.id===t);return n?.label?n.label:e.channelLabels?.[t]??t}function _(n){return e`
            ...
            <div class="form-grid cron-form-grid">
              <label class="field">
                ...
                <input
                  ...
                  aria-describedby=${u(r.fieldErrors.name?y(`name`):void 0)}
          ...
          <section class="cron-form-section">
              ...
              ${o?e`
                    <label class="field">
                      ...
                      <input
                        ...
                        aria-describedby=${u(r.fieldErrors.timeoutSeconds?y(`timeoutSeconds`):void 0)}
            ...
            <label class="field cron-span-2">
              ...
              <textarea
                ...
                aria-describedby=${u(r.fieldErrors.payloadText?y(`payloadText`):void 0)}
                    ...
                    <label class="field ${F===`webhook`?`cron-span-2`:``}">
                      ...
                      ${F===`webhook`?e`
                            <input
                              ...
                              aria-describedby=${u(r.fieldErrors.deliveryTo?y(`deliveryTo`):void 0)}
                    ...
                    <div class="cron-stagger-group cron-span-2">
                      <label class="field">
                        ...
                        <input
                          ...
                          aria-describedby=${u(r.fieldErrors.staggerAmount?y(`staggerAmount`):void 0)}
                    ...
                    ${r.form.failureAlertMode===`custom`?e`
                          <label class="field">
                            ...
                            <input
                              ...
                              aria-describedby=${u(r.fieldErrors.failureAlertAfter?y(`failureAlertAfter`):void 0)}
                          ...
                          <label class="field">
                            ...
                            <input
                              ...
                              aria-describedby=${u(r.fieldErrors.failureAlertCooldownSeconds?y(`failureAlertCooldownSeconds`):void 0)}
  ...
  `}function E(n){let r=n.form;return r.scheduleKind===`at`?e`
      <label class="field cron-span-2" style="margin-top: 12px;">
        ...
        <input
          ...
          aria-describedby=${u(n.fieldErrors.scheduleAt?y(`scheduleAt`):void 0)}
      ...
      <div class="form-grid cron-form-grid" style="margin-top: 12px;">
        <label class="field">
          ...
          <input
            ...
            aria-describedby=${u(n.fieldErrors.everyAmount?y(`everyAmount`):void 0)}
    ...
    <div class="form-grid cron-form-grid" style="margin-top: 12px;">
      <label class="field">
        ...
        <input
          ...
          aria-describedby=${u(n.fieldErrors.cronExpr?y(`cronExpr`):void 0)}
  ...
  `}function D(r,i){return r?e`<div id=${u(i)} class="cron-help cron-error">${t(r)}</div>`:n}function O(r,i){let a=`list-item list-item-clickable cron-job${i.runsJobId===r.id?` list-item-selected`:``}`,o=e=>{i.onLoadRuns(r.id),e()};return e`
      ...
      <div class="cron-run-entry__header">
        <div class="list-main cron-run-entry__main">
          ...
          <div class="chip-row" style="margin-top: 4px;">
            ...
            ${a.model?e`<span class="chip">${a.model}</span>`:n}
            ${a.provider?e`<span class="chip">${a.provider}</span>`:n}
            ${m?e`<span class="chip">${m}</span>`:n}
          </div>
        </div>
        <div class="list-meta cron-run-entry__meta">
          <div>${r(a.ts)}</div>
          ${typeof a.runAtMs==`number`?e`<div class="muted">${t(`cron.runEntry.runAt`)} ${r(a.runAtMs)}</div>`:n}
          <div class="muted">${a.durationMs??0}ms</div>
          ${typeof a.nextRunAtMs==`number`?e`<div class="muted">${M(a.nextRunAtMs)}</div>`:n}
          ${u?e`<div>
                <a
                  class="session-link"
                  href=${u}
                  @click=${e=>{e.defaultPrevented||e.button!==0||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||l&&a.sessionKey&&(e.preventDefault(),l(a.sessionKey))}}
                  >${t(`cron.runEntry.openRunChat`)}</a
                >
              </div>`:n}
          ${g?e`<div class="muted">${a.error}</div>`:n}
          ${a.deliveryError?e`<div class="muted">${a.deliveryError}</div>`:n}
        </div>
      </div>
...
//# sourceMappingURL=cron-Cs-6AaWK.js.map