...
import { r as openBoundaryFile } from "./boundary-file-read-C8TEdk8a.js";
...
import { a as normalizeInputProvenance, n as applyInputProvenanceToUserMessage, r as hasInterSessionUserProvenance } from "./input-provenance-DhG5f54s.js";
import { s as getCompactionProvider } from "./loader--FR-1ZCZ.js";
...
import { B as resolveProviderTransportTurnStateWithPlugin, K as sanitizeProviderReplayHistoryWithPlugin, U as resolveProviderWebSocketSessionPolicyWithPlugin, X as validateProviderReplayTurnsWithPlugin, k as resolveProviderCacheTtlEligibility, nt as resolveProviderRuntimePlugin } from "./provider-runtime-CwkNkui5.js";
import "./model-selection-GlsOqTDm.js";
import { n as createDebugProxyWebSocketAgent, r as resolveDebugProxySettings } from "./env-SyWbZ-M-.js";
import { n as captureWsEvent } from "./runtime-D0LhpKDh.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-BjfVYf2N.js";
import { c as resolveProviderRequestPolicyConfig, i as getModelProviderRequestTransport, r as buildProviderRequestTlsClientOptions } from "./provider-request-config-R6tp_Cvt.js";
import { c as createExpiringMapCache, d as resolveCacheTtlMs, u as isCacheEnabled } from "./store-cache-aeFgCAch.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-CI8Ym6av.js";
import { a as normalizeAssistantPhase, o as parseAssistantTextSignature, t as encodeAssistantTextSignature } from "./chat-message-content-yS6GJLKi.js";
import { a as makeZeroUsageSnapshot, o as normalizeUsage } from "./usage-7Pk1eenJ.js";
import { g as jsonUtf8BytesOrInfinity, m as firstEnumerableOwnKeys, p as boundedJsonUtf8Bytes } from "./session-utils.fs-BgGqlqA-.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-DIrNhXW1.js";
import { o as resolveContextWindowInfo } from "./context-window-guard-BIgyEo4u.js";
import { a as isSilentReplyText } from "./tokens-D3yEVrkk.js";
import { c as stripHeartbeatToken } from "./heartbeat-CwuZimI4.js";
import { _ as sanitizeGoogleTurnOrdering, c as downgradeOpenAIFunctionCallReasoningPairs, d as isGoogleModelApi, l as downgradeOpenAIReasoningBlocks, n as validateGeminiTurns, s as sanitizeSessionMessagesImages, t as validateAnthropicTurns, u as isGemma4ModelRequiringReasoningStrip } from "./pi-embedded-helpers-QjS8cMrW.js";
import { n as extractToolResultId, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-CYE4DX47.js";
...
import { t as createAgentToolResultMiddlewareRunner } from "./tool-result-middleware-D5J2jmZy.js";
import { c as mapOpenAIReasoningEffortForModel, i as createBoundaryAwareStreamFnForModel, l as resolveOpenAIStrictToolSetting, o as normalizeOpenAIStrictToolParameters, s as resolveOpenAIStrictToolFlagForInventory } from "./provider-stream-BtN3gEYv.js";
import { i as normalizeOpenAIReasoningEffort } from "./openai-responses-payload-policy-DJhGfXAS.js";
import { t as log$1 } from "./logger-8xw2ZKab.js";
import { y as resolveOpenAITextVerbosity } from "./proxy-stream-wrappers-DBV20X_t.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-BWaaicTu.js";
import { r as hasCopilotVisionInput, t as buildCopilotDynamicHeaders } from "./copilot-dynamic-headers-BOfXPZzF.js";
import { s as mergeTransportMetadata } from "./transport-stream-shared-B2gu_mC8.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-D9T_omS-.js";
import { t as collectTextContentBlocks } from "./content-blocks-D1wobhfn.js";
import { c as formatContextLimitTruncationNotice, r as resolveLiveToolResultMaxChars, s as truncateToolResultMessage } from "./tool-result-truncation-Dgja2yqK.js";
import { a as toToolDefinitions } from "./pi-tool-definition-adapter-BANKp4Hb.js";
import { i as setRawSessionAppendMessage, r as getRawSessionAppendMessage } from "./transcript-rewrite-D1GDBpQp.js";
import { i as resolveSkillRuntimeConfig } from "./env-overrides-B5D5lEDk.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-DjYIOmet.js";
import "./skills-D32FLcmG.js";
import { i as resolveUserTimezone } from "./date-time-Dq_cdXfZ.js";
import { T as shouldPreserveThinkingBlocks } from "./provider-model-shared-Bqo51Ufw.js";
import { T as isAnthropicModelRef, w as isAnthropicFamilyCacheTtlEligible } from "./provider-stream-shared-C_b_e9Jg.js";
import { o as isGooglePromptCacheEligible } from "./extra-params-umsBOK3Q.js";
import { t as withTimeout } from "./with-timeout-JkpU6HA2.js";
import { n as resolveCronStyleNow } from "./current-time-CNz0_Ppu.js";
import { a as pruneHistoryForContextShare, i as estimateMessagesTokens, n as SUMMARIZATION_OVERHEAD_TOKENS, o as resolveContextWindowTokens$1, r as computeAdaptiveChunkRatio, s as summarizeInStages } from "./compaction-CciVUU6P.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-kSLWiQUG.js";
import "./query-B_rdTx5-.js";
import { i as wrapUntrustedPromptDataBlock, t as buildAgentSystemPrompt } from "./system-prompt-Ble5uzBt.js";
import { t as estimateStringChars } from "./cjk-chars-BExHXToM.js";
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-CccVdx20.js";
	...
	for (const message of messages) {
		...
		if (Array.isArray(replayContent)) {
			...
			const sanitizedContent = replayContent.map((block) => {
				...
				if (strippedText === text) return block;
				contentTouched = true;
				return {
					...block,
					text: strippedText.trim() ? strippedText : OMITTED_INBOUND_METADATA_TEXT
...
//#endregion
export { readPostCompactionContext as A, repairSessionFileIfNeeded as B, validateReplayTurns as C, buildEmbeddedExtensionFactories as D, limitHistoryTurns as E, isCacheTtlEligibleProvider as F, releaseWsSession as G, dropReasoningFromHistory as H, readLastCacheTtlTimestamp as I, resolveChannelCapabilities as J, buildStreamErrorAssistantMessage as K, resolveTranscriptPolicy as L, setCompactionSafeguardCancelReason as M, compactWithSafetyTimeout as N, hasMeaningfulConversationContent as O, resolveCompactionTimeoutMs as P, shouldAllowProviderOwnedThinkingReplay as R, sanitizeSessionHistory as S, getDmHistoryLimitFromSessionKey as T, dropThinkingBlocks as U, assessLastAssistantMessage as V, isZeroUsageEmptyStopAssistantTurn as W, resolveEmbeddedAgentStreamFn as _, mapThinkingLevel as a, trackSessionManagerAccess as b, collectAllowedToolNames as c, applySystemPromptOverrideToSession as d, buildEmbeddedSystemPrompt as f, resolveEmbeddedAgentBaseStreamFn as g, resolveEmbeddedAgentApiKey as h, flushPendingToolResultsAfterIdle as i, consumeCompactionSafeguardCancelReason as j, isRealConversationMessage as k, collectRegisteredToolNames as l, describeEmbeddedAgentStreamStrategy as m, shouldRotateCompactionTranscript as n, splitSdkTools as o, createSystemPromptOverride as p, buildUsageWithNoCost as q, dedupeDuplicateUserMessagesForCompaction as r, PI_RESERVED_TOOL_NAMES as s, rotateTranscriptAfterCompaction as t, toSessionToolAllowlist as u, resolveEmbeddedRunSkillEntries as v, buildEmbeddedMessageActionDiscoveryInput as w, normalizeAssistantReplayContent as x, prewarmSessionFile as y, guardSessionManager as z };
