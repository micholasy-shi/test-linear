...
import { a as OLLAMA_DEFAULT_MAX_TOKENS, i as OLLAMA_DEFAULT_COST, n as OLLAMA_DEFAULT_BASE_URL } from "./defaults-BVi8bELI.js";
...
function buildOllamaModelDefinition(modelId, contextWindow, capabilities) {
	...
	const compat = capabilities === void 0 ? void 0 : { supportsTools: capabilities.includes("tools") };
	return {
		id: modelId,
		name: modelId,
		reasoning,
