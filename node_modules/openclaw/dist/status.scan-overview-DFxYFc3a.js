...
import { s as hasConfiguredChannelsForReadOnlyScope } from "./channel-plugin-ids-BLUq4AzU.js";
import { t as createEmptyTaskRegistrySummary } from "./task-registry.summary-NyGop591.js";
import { n as createEmptyTaskAuditSummary } from "./task-registry.audit.shared-DykdF_Dt.js";
...
function loadGatewayProbeModule() {
	gatewayProbeModulePromise ??= import("./status.gateway-probe-D16QsT1P.js");
...
function loadStatusScanDepsRuntimeModule() {
	statusScanDepsRuntimeModulePromise ??= import("./status.scan.deps.runtime-lp4hcG3i.js");
	return statusScanDepsRuntimeModulePromise;
}
function loadStatusAgentLocalModule() {
	statusAgentLocalModulePromise ??= import("./status.agent-local-BmBBFw08.js");
	return statusAgentLocalModulePromise;
}
function loadStatusUpdateModule() {
	statusUpdateModulePromise ??= import("./status.update-Bbh3KSre.js");
	return statusUpdateModulePromise;
}
function loadStatusScanRuntimeModule() {
	statusScanRuntimeModulePromise ??= import("./status.scan.runtime-S9UE84YC.js");
	return statusScanRuntimeModulePromise;
}
function loadGatewayCallModule() {
	gatewayCallModulePromise ??= import("./call-DH9e33Y7.js");
	return gatewayCallModulePromise;
}
function loadStatusSummaryModule() {
	statusSummaryModulePromise ??= import("./status.summary-x8Oal7W2.js");
...
function loadCommandConfigResolutionModule() {
	commandConfigResolutionModulePromise ??= import("./command-config-resolution-DF-NCEpw.js");
	return commandConfigResolutionModulePromise;
}
function loadCommandSecretTargetsModule() {
	commandSecretTargetsModulePromise ??= import("./command-secret-targets-SPHUpw6H.js");
