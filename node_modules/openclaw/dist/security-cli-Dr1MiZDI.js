...
import { d as createIcaclsResetCommand, f as formatIcaclsResetCommand } from "./audit-fs-CC0pbmDU.js";
import { c as normalizeAgentId } from "./session-key-hxP9B3Or.js";
import { S as resolveDefaultAgentId } from "./agent-scope-i10se9ty.js";
import { i as getRuntimeConfig, r as createConfigIO } from "./io-CFdEhZuM.js";
...
import { s as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-Cj5-iVXn.js";
import { t as formatHelpExamples } from "./help-format-DNTD3upA.js";
import { t as runSecurityAudit } from "./audit-lno7WqNt.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-CGlmJEtf.js");
