...
import { n as openUrl } from "./browser-open-Drrwu02w.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-lXVgXQ-j.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-CfSnyp0I.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-shvAXzZG.js";
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-CFJ4q9So.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const [{ ensureOnboardingPluginInstalled }, { clearPluginDiscoveryCache }] = await Promise.all([import("./onboarding-plugin-install-D9YkxL7v.js"), import("./discovery-8XSwlbkE.js")]);
