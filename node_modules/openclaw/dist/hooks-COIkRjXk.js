...
import { a as createAuthRateLimiter, o as normalizeRateLimitClientIp, r as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH } from "./auth-rate-limit-Cms-RqVX.js";
...
import { r as resolveHookExternalContentSource } from "./external-content-source-DaPutKgf.js";
	...
	const dispatchAgentHook = (value) => {
		...
		(async () => {
			try {
				...
				const { runCronIsolatedAgentTurn } = await import("./isolated-agent-CwSSuPq0.js");
