...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-D97L2HdA.js";
import "./webhook-ingress-CAGeq6oN.js";
import { _ as resolveRealtimeVoiceAgentConsultTools, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, v as resolveRealtimeVoiceAgentConsultToolsAllow } from "./session-runtime-DOWNBdF0.js";
import { o as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-CXHWLV1H.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-C0uVw9GU.js";
import { t as zod_exports } from "./zod-K08bzDG0.js";
import "./api-BpZsjPsQ.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-dq8yIvtn.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-CVWNQAGC.js";
import { t as resolveVoiceResponseModel } from "./response-model-C7N19ZcJ.js";
import { t as isProviderStatusTerminal } from "./call-status-DQRshXhF.js";
import { t as getHeader } from "./http-headers-C5eplnqp.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-TPomGfBs.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-BnF0p0jM.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-CrYHD0MM.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-BvvtZITB.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-BcP90qgB.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-DR18E9t-.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-Cld3UjCb.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-CIzLcRC7.js");
