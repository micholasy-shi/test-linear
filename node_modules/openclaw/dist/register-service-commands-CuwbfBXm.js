...
function loadDaemonInstallModule() {
	daemonInstallModulePromise ??= import("./install.runtime-B0mU4hHe.js");
	return daemonInstallModulePromise;
}
function loadDaemonLifecycleModule() {
	daemonLifecycleModulePromise ??= import("./lifecycle.runtime-deXv73Lm.js");
	return daemonLifecycleModulePromise;
}
function loadDaemonStatusModule() {
	daemonStatusModulePromise ??= import("./status.runtime-DueV2lSA.js");
