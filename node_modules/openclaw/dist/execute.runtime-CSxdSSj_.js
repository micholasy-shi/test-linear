...
import { p as scopedHeartbeatWakeOptions } from "./session-key-hxP9B3Or.js";
import { t as applyPluginTextReplacements } from "./plugin-text-transforms-CppVSZSV.js";
import { i as emitAgentEvent } from "./agent-events-1--MOtpo.js";
import { a as prependBootstrapPromptWarning } from "./bootstrap-budget-FLCjP_87.js";
import "./pi-embedded-helpers-QjS8cMrW.js";
import { t as classifyFailoverReason } from "./errors-CZgkAaRj.js";
import { s as resolveFailoverStatus, t as FailoverError } from "./failover-error-DQkWPkYr.js";
...
async function executePreparedCliRun(context, cliSessionIdToUse) {
	...
	try {
		return await enqueueCliRun(queueKey, async () => {
			...
			try {
				cliBackendLog.info(`cli exec: provider=${params.provider} model=${context.normalizedModel} promptChars=${basePrompt.length}`);
