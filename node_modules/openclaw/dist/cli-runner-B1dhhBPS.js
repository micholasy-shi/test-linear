...
import "./tokens-D3yEVrkk.js";
import "./pi-embedded-helpers-QjS8cMrW.js";
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-CZgkAaRj.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-DQkWPkYr.js";
import { i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-CRLbtANH.js";
import { i as buildAgentHookConversationMessages, n as loadCliSessionHistoryMessages } from "./session-history-NSq5BE4m.js";
...
async function runCliAgent(params) {
	...
	const { prepareCliRunContext } = await import("./prepare.runtime-O4dLDhbV.js");
	const context = await prepareCliRunContext(params);
	try {
		return await runPreparedCliAgent(context);
	} finally {
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-BKZ5VJZU.js");
			closeClaudeLiveSessionForContext(context);
		}
	}
}
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-CSxdSSj_.js");
