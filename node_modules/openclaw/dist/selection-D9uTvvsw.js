...
import { c as createChildDiagnosticTraceContext, d as formatDiagnosticTraceparent, f as freezeDiagnosticTraceContext, r as emitTrustedDiagnosticEvent, u as createDiagnosticTraceContextFromActiveScope } from "./diagnostic-events-B5Jlu4QM.js";
import { t as createSubsystemLogger } from "./subsystem-rHhUC6qs.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey } from "./session-key-utils-naHBWFyS.js";
import { c as normalizeAgentId } from "./session-key-hxP9B3Or.js";
import { g as listAgentEntries, m as resolveSessionAgentIds } from "./agent-scope-i10se9ty.js";
import { n as resolveOwnerDisplaySetting } from "./owner-display-BBJ65Ssl.js";
import { ot as isCliRuntimeAlias, rt as normalizeGoogleApiBaseUrl } from "./io-CFdEhZuM.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-Cx1zyNpE.js";
import { u as normalizeMessageChannel } from "./message-channel-B32dwK-Q.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-CppVSZSV.js";
import { u as listRegisteredAgentHarnesses } from "./loader--FR-1ZCZ.js";
import { c as listRegisteredPluginAgentPromptGuidance } from "./command-registration-h0xR6wWQ.js";
import { t as fireAndForgetBoundedHook } from "./fire-and-forget-i2jhDHu7.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-_PCECtwt.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-Df1Zlb_-.js";
import { L as resolveProviderSystemPromptContribution, R as resolveProviderTextTransforms, Y as transformProviderSystemPrompt } from "./provider-runtime-CwkNkui5.js";
...
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-K3Q805Kl.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-CDAQsjZ7.js";
import { n as estimateBase64DecodedBytes } from "./base64-jn7E7URN.js";
import { m as MAX_IMAGE_BYTES } from "./mime-B-vvNIo6.js";
import { p as normalizeToolName } from "./tool-policy-CC72sL8W.js";
import { n as acquireSessionWriteLock, o as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-L2DXbmZV.js";
import { c as resolveAssistantMessagePhase, o as parseAssistantTextSignature } from "./chat-message-content-yS6GJLKi.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-1--MOtpo.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-7Pk1eenJ.js";
import { t as parseInlineDirectives } from "./directive-tags-B2h2NkjE.js";
import { n as resolveEmbeddedAgentHarnessFallback, r as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-JGTBNnrt.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-CErUjrXs.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText, s as stripLeadingSilentToken } from "./tokens-D3yEVrkk.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-CghaDFYH.js";
import { B as repairSessionFileIfNeeded, C as validateReplayTurns, D as buildEmbeddedExtensionFactories, E as limitHistoryTurns, F as isCacheTtlEligibleProvider, G as releaseWsSession, H as dropReasoningFromHistory, I as readLastCacheTtlTimestamp, J as resolveChannelCapabilities, K as buildStreamErrorAssistantMessage, L as resolveTranscriptPolicy, P as resolveCompactionTimeoutMs, R as shouldAllowProviderOwnedThinkingReplay, S as sanitizeSessionHistory, T as getDmHistoryLimitFromSessionKey, U as dropThinkingBlocks, V as assessLastAssistantMessage, W as isZeroUsageEmptyStopAssistantTurn, _ as resolveEmbeddedAgentStreamFn, a as mapThinkingLevel, b as trackSessionManagerAccess, c as collectAllowedToolNames, d as applySystemPromptOverrideToSession, f as buildEmbeddedSystemPrompt, g as resolveEmbeddedAgentBaseStreamFn, h as resolveEmbeddedAgentApiKey, i as flushPendingToolResultsAfterIdle, l as collectRegisteredToolNames, m as describeEmbeddedAgentStreamStrategy, n as shouldRotateCompactionTranscript, o as splitSdkTools, p as createSystemPromptOverride, s as PI_RESERVED_TOOL_NAMES, t as rotateTranscriptAfterCompaction, u as toSessionToolAllowlist, v as resolveEmbeddedRunSkillEntries, w as buildEmbeddedMessageActionDiscoveryInput, x as normalizeAssistantReplayContent, y as prewarmSessionFile, z as guardSessionManager } from "./compaction-successor-transcript-CFukhZtt.js";
import { f as isStrictAgenticSupportedProviderModel, m as isEmbeddedMode, p as stripProviderPrefix } from "./openclaw-tools-C7Or31if.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-h5pqfmuE.js";
...
import { n as resolveCommitHash } from "./git-commit-BIq23eH7.js";
import { t as resolveOsSummary } from "./os-summary-DHi-mWNZ.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-DSVR3jb7.js";
...
import { t as isReasoningTagProvider } from "./provider-utils-CXtmD0TS.js";
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-FLCjP_87.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-Ddypv-c6.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DXl6MPAr.js";
...
import { T as parseExecApprovalResultText, d as stableStringify$1, f as coerceChatContentText, p as extractTextFromChatContent } from "./sanitize-user-facing-text-DgEphtot.js";
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-CZgkAaRj.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-C_nvYxR5.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-CYE4DX47.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-gG8dJ_Bm.js";
import { a as listChannelSupportedActions, c as resolveChannelReactionGuidance, o as resolveChannelMessageToolCapabilities, s as resolveChannelMessageToolHints } from "./channel-tools-46H5gILp.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-8T2BSZsT.js";
import { a as isTimeoutError } from "./failover-error-DQkWPkYr.js";
import { t as buildModelAliasLines } from "./model-alias-lines-BxnCITC1.js";
import { t as sanitizeForConsole } from "./console-sanitize-C8JXD5Yc.js";
import { c as resolveModelAuthMode } from "./model-auth-Bic7ggHC.js";
import { i as supportsModelTools } from "./tool-result-middleware-D5J2jmZy.js";
import { t as registerProviderStreamForModel } from "./provider-stream-BtN3gEYv.js";
import { t as log$4 } from "./logger-8xw2ZKab.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-BWaaicTu.js";
import { c as sanitizeTransportPayloadText, o as mergeTransportHeaders, u as buildGuardedModelFetch } from "./transport-stream-shared-B2gu_mC8.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-D9T_omS-.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-DQnmMmdU.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-HGvJp58Y.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-BRG8c8Rq.js";
import "./pi-bundle-mcp-tools-Bck95tFX.js";
import { n as setReplyPayloadMetadata } from "./reply-payload--nNIIR5I.js";
import { r as parseFenceSpans } from "./fences-C1pdR-R7.js";
import { r as splitMediaFromOutput } from "./parse-DbkqxPau.js";
import { u as parseReplyDirectives } from "./payloads-Br5VEYXq.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-Cy4FCQXC.js";
import { _ as isToolResultTimedOut, b as isMessagingToolSendAction, d as extractMessagingToolSend, f as extractToolErrorMessage, g as isToolResultError, h as filterToolResultMediaUrls, l as logAgentRuntimeToolDiagnostics, m as extractToolResultText, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractToolResultMediaArtifact, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as normalizeAgentRuntimeTools, v as sanitizeToolResult, x as formatToolAggregate, y as isMessagingTool } from "./attempt.tool-run-context-BO5J6jJJ.js";
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-Ntlu467h.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-C90lJNMO.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-Bo9VOdZK.js";
import { t as collectTextContentBlocks } from "./content-blocks-D1wobhfn.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-DQgoDbaa.js";
...
import { d as createPreparedEmbeddedPiSettingsManager, l as installContextEngineLoopHook, o as truncateOversizedToolResultsInSessionManager, r as resolveLiveToolResultMaxChars, u as installToolResultContextGuard } from "./tool-result-truncation-Dgja2yqK.js";
import { n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-BIyj5b9L.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-B7bDKsIw.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-BANKp4Hb.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-oOiy-pNP.js";
...
import { c as setActiveEmbeddedRun, l as updateActiveEmbeddedRunSnapshot, n as clearActiveEmbeddedRun } from "./runs-CCsjme9h.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DEUZP4Cb.js";
import { o as resolveSandboxContext } from "./sandbox-C77UjGet.js";
import { t as detectRuntimeShell } from "./shell-utils-fRpmcPUC.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-B5D5lEDk.js";
import { s as resolveSkillsPromptForRun } from "./workspace-DjYIOmet.js";
import "./skills-D32FLcmG.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-2UdHVcDn.js";
...
import "./tool-loop-detection-DM5A0xwA.js";
import { S as visitObjectContentBlocks, a as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-C_b_e9Jg.js";
import { n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-umsBOK3Q.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-Bq7hIoub.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-l3yBXibj.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-Ble5uzBt.js";
...
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-B4WBojDo.js";
...
import { t as resolveBootstrapMode } from "./bootstrap-mode-kx3ImgVx.js";
import { a as shouldUseOpenAIWebSocketTransport, i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-DkPRI3t6.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-CMmZ32XQ.js";
import { t as detectAndLoadPromptImages } from "./images-DlCi8HRj.js";
import { n as shouldPreemptivelyCompactBeforePrompt, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-U7Hgg4_E.js";
import { n as queueRuntimeContextForNextTurn, r as resolveRuntimeContextPromptParts } from "./runtime-context-prompt-BZWyPA2L.js";
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-D3txDouV.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-ByDtJzBm.js");
	return execApprovalReplyModulePromise;
}
function loadHookRunnerGlobal() {
	hookRunnerGlobalModulePromise ??= import("./hook-runner-global-Bosx1Wsd.js");
	return hookRunnerGlobalModulePromise;
}
function loadMediaParse() {
	mediaParseModulePromise ??= import("./parse-CP0mVLD5.js");
	return mediaParseModulePromise;
}
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-B_0uNvj7.js");
...
async function runEmbeddedAttempt(params) {
	...
	try {
		...
		const toolsRaw = params.disableTools || params.modelRun ? [] : applyEmbeddedAttemptToolsAllow(createOpenClawCodingTools({
			agentId: sessionAgentId,
		...
		const promptMode = params.promptMode ?? (params.modelRun ? "none" : resolvePromptModeForSession(params.sessionKey));
			...
			try {
				...
				try {
					...
					if (!skipPromptSubmission && !promptSubmission.runtimeOnly && !hasPromptSubmissionContent({
						...
						skipPromptSubmission = true;
						log$4.info(`embedded run prompt skipped: empty prompt/history/images runId=${params.runId} sessionId=${params.sessionId} trigger=${params.trigger} provider=${params.provider}/${params.modelId}`);
...
//#endregion
export { resolveTrajectoryFilePath as C, sanitizeDiagnosticPayload as D, safeJsonStringify as E, TRAJECTORY_RUNTIME_FILE_MAX_BYTES as S, safeTrajectorySessionFileName as T, resolveRunLivenessState as _, prepareSessionManagerForRun as a, createEmbeddedRunReplayState as b, isLikelyExecutionAckPrompt as c, resolveEmptyResponseRetryInstruction as d, resolveIncompleteTurnPayloadText as f, resolveReplayInvalidFlag as g, resolveReasoningOnlyRetryInstruction as h, selectAgentHarness as i, resolveAckExecutionFastPathInstruction as l, resolvePlanningOnlyRetryLimit as m, resolveAgentHarnessPolicy as n, STRICT_AGENTIC_BLOCKED_TEXT as o, resolvePlanningOnlyRetryInstruction as p, runAgentHarnessAttemptWithFallback as r, extractPlanningOnlyPlanDetails as s, maybeCompactAgentHarnessSession as t, resolveAttemptReplayMetadata as u, resolveSilentToolResultReplyPayload as v, resolveTrajectoryPointerFilePath as w, observeReplayMetadata as x, shouldTreatEmptyAssistantReplyAsSilent as y };
