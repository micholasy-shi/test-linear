...
function resolveLinuxUserBinDirs(home, env) {
	...
	dirs.push(`${home}/.local/share/fnm/aliases/default/bin`);
	dirs.push(`${home}/.local/share/fnm/current/bin`);
	dirs.push(`${home}/.fnm/aliases/default/bin`);
