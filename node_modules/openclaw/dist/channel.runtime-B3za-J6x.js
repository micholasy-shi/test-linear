...
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-CduZ45Oa.js";
import "./webhook-ingress-CAGeq6oN.js";
import "./security-runtime-CFwNSu4C.js";
import "./string-coerce-runtime-C86cROGv.js";
import { P as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-SWKxulel.js";
import { t as getBlueBubblesRuntime } from "./runtime-CwAqg06u.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-C136eaxI.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-CSuPdEl4.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-BUcYvyOR.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-DT7pthNf.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {
