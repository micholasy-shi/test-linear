...
import { s as loadAuthProfileStoreForRuntime } from "./store-D-8DaAtv.js";
import { n as resolvePluginProviders } from "./providers.runtime-h1H6iyrA.js";
import "./model-selection-shared-VQV3de71.js";
...
import { n as clearAuthProfileCooldown } from "./usage-BxJGDEXo.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-DXTkz4Qb.js";
...
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-CbfwZExx.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-shvAXzZG.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-C0vnH00S.js";
import { t as isRemoteEnvironment } from "./remote-env-DZmt7tnF.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-rUrMc8dI.js");
				await openUrl(url);
			},
