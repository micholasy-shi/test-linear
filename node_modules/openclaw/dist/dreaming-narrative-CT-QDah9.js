...
import { c as readErrorName, i as formatErrorMessage, r as extractErrorCode } from "./errors-CDFVCV9D.js";
import { t as resolveGlobalMap } from "./global-singleton-COlWgaGc.js";
import { i as getRuntimeConfig } from "./io-CFdEhZuM.js";
import { n as createAsyncLock } from "./json-files-C6eUYM9r.js";
...
async function generateAndAppendDreamNarrative(params) {
	...
	try {
		...
		if (shouldDeleteSession && params.subagent) try {
