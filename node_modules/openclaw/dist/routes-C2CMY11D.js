...
import { D as DEFAULT_AI_SNAPSHOT_MAX_CHARS, E as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, N as DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS, d as parseBrowserHttpUrl, n as assertCdpEndpointAllowed, p as withCdpSocket } from "./cdp.helpers-BROBy6Ra.js";
import { a as BrowserProfileUnavailableError, c as BrowserTabNotFoundError, d as toBrowserErrorResponse, i as BrowserProfileNotFoundError, l as BrowserTargetAmbiguousError, n as BrowserConflictError, r as BrowserError, s as BrowserResourceExhaustedError, u as BrowserValidationError } from "./errors-mgRbu9kw.js";
import { a as DEFAULT_DOWNLOAD_DIR, c as resolveExistingPathsWithinRoot, i as resolveProfile, o as DEFAULT_TRACE_DIR, r as resolveManagedBrowserHeadlessMode, s as DEFAULT_UPLOAD_DIR, u as resolveWritablePathWithinRoot } from "./config-B0K_3bA1.js";
import "./control-auth-C4d-RiVz.js";
import { r as resolveBrowserExecutableForPlatform } from "./chrome.executables-BBSgAn9Y.js";
import { n as normalizeString } from "./record-shared-bCZHBhQa.js";
import { t as movePathToTrash } from "./trash-CLcRy7y3.js";
import { C as assertBrowserNavigationResultAllowed, T as withBrowserNavigationPolicy, _ as INTERACTIVE_ROLES, a as resolveOpenClawUserDataDir, g as CONTENT_ROLES, h as snapshotRoleViaCdp, m as snapshotAria, t as getChromeWebSocketUrl, u as captureScreenshot, v as STRUCTURAL_ROLES, x as assertBrowserNavigationAllowed, y as resolveBrowserNavigationProxyMode } from "./chrome-D34UDr-8.js";
import { E as uploadChromeMcpFile, T as takeChromeMcpSnapshot, _ as navigateChromeMcpPage, a as closeChromeMcpTab, c as evaluateChromeMcpScript, f as getChromeMcpPid, l as fillChromeMcpElement, m as hoverChromeMcpElement, n as clickChromeMcpCoords, o as dragChromeMcpElement, r as clickChromeMcpElement, u as fillChromeMcpForm, w as takeChromeMcpScreenshot, x as resizeChromeMcpPage, y as pressChromeMcpKey } from "./chrome-mcp-BSNezaWD.js";
import { a as shouldUsePlaywrightForAriaSnapshot, i as resolveDefaultSnapshotFormat, n as getPwAiModule$1, o as shouldUsePlaywrightForScreenshot, r as getBrowserProfileCapabilities, t as resolveTargetIdFromTabs } from "./target-id-BycuV22F.js";
import { c as ACT_MAX_CLICK_DELAY_MS, l as ACT_MAX_WAIT_TIME_MS, o as normalizeBrowserFormField, p as matchBrowserUrlPattern, r as getRoleSnapshotStats, u as normalizeActBoundedNonNegativeMs } from "./pw-role-snapshot-DlDBmjPJ.js";
...
async function runBrowserLiveProbe(req, ctx) {
	...
	try {
		...
		if (capabilities.usesChromeMcp) {
			const { takeChromeMcpSnapshot } = await import("./chrome-mcp-unA3qM7M.js");
