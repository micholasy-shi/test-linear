...
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-BCkJhPwy.js";
import { c as normalizeAgentId } from "./session-key-hxP9B3Or.js";
import { n as MANIFEST_KEY } from "./legacy-names-B-GxWRNk.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-BuBBr5a3.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-DZ1H6DgZ.js");
...
function loadAuditFsModule() {
	auditFsModulePromise ??= import("./audit-fs-reg9HOp8.js");
	return auditFsModulePromise;
}
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-CGzrSsdb.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-DZz-ZdWm.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-B1hKcV3T.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-Ckg58U6g.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-D-cBqZOr.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-CAHPQkpw.js");
