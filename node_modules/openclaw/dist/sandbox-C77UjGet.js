...
import { f as isSameSsrFPolicy } from "./ssrf-K8pX0Zi6.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Ddypv-c6.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, y as SANDBOX_BROWSER_SECURITY_HASH_EPOCH } from "./constants-xznpxx5E.js";
import { n as isToolAllowed } from "./tool-policy-UrAjLI8q.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-CQFOzXWD.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-C_nvYxR5.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-BdrQ0pdY.js";
import { n as resolveBrowserControlAuth, t as ensureBrowserControlAuth } from "./browser-control-auth-mSWSPREo.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-BZic60rC.js";
import { C as updateRegistry, S as updateBrowserRegistry, _ as slugifySessionKey, a as execDocker, b as removeBrowserRegistryEntry, c as readDockerContainerLabel, d as readDockerPort, g as resolveSandboxWorkspaceDir, h as resolveSandboxScopeKey, l as readDockerNetworkDriver, m as resolveSandboxAgentId, n as dockerContainerState, p as appendWorkspaceMountArgs, s as readDockerContainerEnvVar, t as buildSandboxCreateArgs, u as readDockerNetworkGateway, v as readBrowserRegistry, w as computeSandboxBrowserConfigHash, x as removeRegistryEntry, y as readRegistry } from "./docker-BhXHIHLp.js";
import { a as splitSandboxBindSpec, i as resolveSandboxHostPathViaExistingAncestor, n as validateNetworkMode } from "./validate-sandbox-security-o2N7XlVA.js";
import { C as buildPinnedMkdirpPlan, D as dockerSandboxBackendManager, E as buildPinnedWritePlan, O as runDockerSandboxShellCommand, T as buildPinnedRenamePlan, a as getSandboxBackendManager, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedRemovePlan, y as normalizeContainerPath } from "./browser-bridges-Bw86OH91.js";
import { n as deriveDefaultBrowserCdpPortRange } from "./port-defaults-CnrKybdO.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-C2OkichO.js"),
				import("./exec-defaults-D_qLy6ol.js"),
				import("./skills-DZ1H6DgZ.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-D7MSz3rV.js")).maybePruneSandboxes(cfg);
