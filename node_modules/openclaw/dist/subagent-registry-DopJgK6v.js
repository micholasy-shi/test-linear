...
import { c as readErrorName, i as formatErrorMessage } from "./errors-CDFVCV9D.js";
...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-1--MOtpo.js";
import { A as subagentRuns, C as SUBAGENT_ENDED_OUTCOME_ERROR, D as SUBAGENT_ENDED_REASON_ERROR, E as SUBAGENT_ENDED_REASON_COMPLETE, O as SUBAGENT_ENDED_REASON_KILLED, S as resolveSubagentSessionStatus, T as SUBAGENT_ENDED_OUTCOME_TIMEOUT, a as countActiveRunsForSessionFromRuns, b as getSubagentSessionRuntimeMs, c as getSubagentRunByChildSessionKeyFromRuns, d as listRunsForControllerFromRuns, i as countActiveDescendantRunsFromRuns, k as SUBAGENT_TARGET_KIND_SUBAGENT, n as persistSubagentRunsToDisk, r as restoreSubagentRunsFromDisk, s as countPendingDescendantRunsFromRuns, t as getSubagentRunsSnapshotForRead, u as listDescendantRunsForRequesterFromRuns, v as isStaleUnendedSubagentRun, w as SUBAGENT_ENDED_OUTCOME_KILLED, x as getSubagentSessionStartedAt } from "./subagent-registry-state-CMMkdmeo.js";
import { a as isSilentReplyText } from "./tokens-D3yEVrkk.js";
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-HGvJp58Y.js";
import "./pi-bundle-mcp-tools-Bck95tFX.js";
import { r as callGateway } from "./call-CP7A3sdw.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-CtT0O0hI.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, s as setDetachedTaskDeliveryStatusByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime-6WfuNV0D.js";
import "./subagent-announce-queue-Dnb5oLYS.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-DILT26j3.js";
import { u as withSubagentOutcomeTiming } from "./subagent-announce-output-V8Qd-Aa3.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-Cx4wrsJo.js";
...
async function loadCleanupBrowserSessionsForLifecycleEnd$1() {
	browserCleanupPromise$1 ??= import("./browser-lifecycle-cleanup-Dai3Ee2h.js");
...
async function loadSubagentAnnounceModule() {
	subagentAnnouncePromise ??= import("./subagent-announce-Dim2fAZI.js");
	return await subagentAnnouncePromise;
}
async function loadCleanupBrowserSessionsForLifecycleEnd() {
	browserCleanupPromise ??= import("./browser-lifecycle-cleanup-Dai3Ee2h.js");
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-yna4u4Xj.js").then(({ scheduleOrphanRecovery }) => {
