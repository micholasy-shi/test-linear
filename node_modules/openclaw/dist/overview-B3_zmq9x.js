...
import { S as resolveDefaultAgentId, g as listAgentEntries, n as resolveAgentEffectiveModelPrimary } from "./agent-scope-i10se9ty.js";
...
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-8T2BSZsT.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	const [codex, claude, gateway, references] = await Promise.all([
		...
		resolveFastTestReferences(env) ?? resolveOpenClawReferencePaths({
