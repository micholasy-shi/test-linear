...
import { n as createOutboundSendDepsFromCliSource, t as CLI_OUTBOUND_SEND_FACTORY } from "./outbound-send-mapping-CuTLg8G3.js";
...
function createDefaultDeps() {
	...
	const resolveSender = (channelId) => createLazySender(channelId, async () => {
		const { createChannelOutboundRuntimeSend } = await import("./channel-outbound-send-ZVCEj-C_.js");
