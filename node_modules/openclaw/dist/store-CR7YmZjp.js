...
import { i as normalizeHyphenSlug } from "./string-normalization-Cz5hTdB3.js";
import { s as writeTextAtomic } from "./json-files-C6eUYM9r.js";
import { i as normalizeChannelId, n as getLoadedChannelPlugin, r as listChannelPlugins } from "./registry-yTN80EXi.js";
import { l as listDeliverableMessageChannels, u as normalizeMessageChannel } from "./message-channel-B32dwK-Q.js";
...
import { i as isSessionArchiveArtifactName, n as isCompactionCheckpointTranscriptFileName, r as isPrimarySessionTranscriptFileName } from "./artifacts-CP6FefaZ.js";
...
import { i as isSessionStoreCacheEnabled, l as getFileStatSnapshot, n as dropSessionStoreObjectCache, o as setSerializedSessionStore, r as getSerializedSessionStore, s as writeSessionStoreCache } from "./store-cache-aeFgCAch.js";
import { a as getActiveSessionMaintenanceWarning, c as rotateSessionFile, i as capEntryCount, l as shouldRunSessionEntryMaintenance, n as normalizeSessionStore, o as pruneStaleEntries, r as resolveMaintenanceConfig, t as loadSessionStore } from "./store-load-DLuD4etm.js";
import { n as mergeSessionEntry, r as mergeSessionEntryPreserveActivity } from "./types-UHw-opRq.js";
import { n as acquireSessionWriteLock, o as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-L2DXbmZV.js";
import { t as LOCK_QUEUES } from "./store-lock-state-BRwjIQE_.js";
...
async function enforceSessionDiskBudget(params) {
	...
	const removableFileQueue = files.filter((file) => isSessionArchiveArtifactName(file.name) || isCompactionCheckpointTranscriptFileName(file.name) && !referencedPaths.has(file.canonicalPath) || isPrimarySessionTranscriptFileName(file.name) && !referencedPaths.has(file.canonicalPath)).toSorted((a, b) => a.mtimeMs - b.mtimeMs);
