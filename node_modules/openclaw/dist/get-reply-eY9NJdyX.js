...
import { n as CHAT_CHANNEL_ORDER } from "./ids-C5uBFLeA.js";
import { t as createSubsystemLogger } from "./subsystem-rHhUC6qs.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey, o as parseAgentSessionKey } from "./session-key-utils-naHBWFyS.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-hxP9B3Or.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-ClDnTm-0.js";
import { b as resolveAgentDir, g as listAgentEntries, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-i10se9ty.js";
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-Cz5hTdB3.js";
import { i as getRuntimeConfig } from "./io-CFdEhZuM.js";
import { a as normalizeAnyChannelId } from "./registry-GHcDenJ3.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-7KX8W8My.js";
...
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-B32dwK-Q.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-DhG5f54s.js";
import { d as resetRegisteredAgentHarnessSessions } from "./loader--FR-1ZCZ.js";
...
import { g as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-Df1Zlb_-.js";
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-DhTFkZJF.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-VQV3de71.js";
import "./model-selection-GlsOqTDm.js";
import { t as normalizeChatType } from "./chat-type-BrFPcj8_.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-cOUkX-pl.js";
import { t as finalizeInboundContext } from "./inbound-context-BSjNVUNw.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-CC72sL8W.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-JXLAAy4Q.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-CHP3g1Fg.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-Bmv0a_G3.js";
import { s as resolveMaintenanceConfigFromInput, t as loadSessionStore } from "./store-load-DLuD4etm.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-UHw-opRq.js";
import { f as deriveSessionMetaPatch, g as resolveGroupSessionKey, l as resolveSessionStoreEntry, o as updateSessionStore } from "./store-CR7YmZjp.js";
...
import { o as resolveAndPersistSessionFile } from "./transcript-BhP11178.js";
import { n as parseSessionThreadInfoFast } from "./thread-info-Dl1e71Qh.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-O7Nzaeee.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-D3yEVrkk.js";
import { r as HEARTBEAT_TRANSCRIPT_PROMPT } from "./heartbeat-CwuZimI4.js";
...
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-BNTty1Eq.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-C_nvYxR5.js";
import { c as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-HGvJp58Y.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-YWJsm0G1.js";
import { i as generateSecureToken } from "./secure-random-BJA7KabS.js";
import { n as resolveSilentReplySettings } from "./silent-reply-Btab7kqB.js";
...
import { r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-DkHh1Ku-.js";
import { a as resolveParentForkMaxTokens, i as forkSessionFromParent, o as resolveParentForkTokenCount } from "./subagent-spawn--QfZonyO.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-DiKONiMC.js";
import { t as hasControlCommand } from "./command-detection-DUg5j-0t.js";
...
import { t as parseSoftResetCommand } from "./commands-reset-mode-DMWVYsQE.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-DBu-D91I.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy } from "./typing-policy-D1jzp2Lv.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-Cozhn2Y4.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-7qjLtn7X.js";
import { t as resolveChannelModelOverride } from "./model-overrides-H0c1OL-j.js";
import { t as normalizeGroupActivation } from "./group-activation-CCArcZ5m.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-DF42DG0b.js";
import { t as resolveFastModeState } from "./fast-mode-_3gtSJl4.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-R2sIrq3b.js";
...
import { t as isDirectiveOnly } from "./directive-handling.directive-only-COauW2jx.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-DCxxDFRO.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-COMnV6qk.js";
...
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-DuK1y-EQ.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-CBx1z2gb.js";
import { t as hasInboundMedia } from "./inbound-media-CZw6TqdX.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-FzXgobo4.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-Dj2fAwlR.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-DKl3prg9.js";
import { r as getCliSessionBinding } from "./cli-session-CIFGuQWg.js";
import { n as resolveResetPreservedSelection, t as clearSessionResetRuntimeState } from "./session-reset-cleanup-CT8VmiMn.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-C9Kyoyqd.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-Bumc9wEP.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-BpEqn4Hk.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-Sf8-WVRk.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-B__6QDOb.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-BVZbb97A.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-BXBvb1pH.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-D26QVUhn.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-Bw152WXz.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-Dc6v3EK8.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-DxbhSCWk.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-DeNM66ce.js");
...
function loadSkillCommandsRuntime() {
	skillCommandsRuntimePromise ??= import("./skill-commands.runtime-DeNM66ce.js");
	return skillCommandsRuntimePromise;
}
function loadOpenClawToolsRuntime() {
	openClawToolsRuntimePromise ??= import("./openclaw-tools.runtime-lO_z9A2u.js");
	return openClawToolsRuntimePromise;
}
function loadAbortCutoffRuntime() {
	abortCutoffRuntimePromise ??= import("./abort-cutoff.runtime-Cfaf0f2-.js");
	return abortCutoffRuntimePromise;
}
function loadCommandsRuntime() {
	commandsRuntimePromise ??= import("./commands.runtime-BBQOlJl9.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-BUvFo4Tm.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-D8yvcjLt.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-Bwz_DStH.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-CirYYbJ1.js");
...
async function runPreparedReply(params) {
	...
	const transcriptBodyBase = isHeartbeat ? HEARTBEAT_TRANSCRIPT_PROMPT : isBareSessionReset ? softResetTail : hasUserBody ? baseBodyFinal : "[User sent media without caption]";
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-CYH-eW6R.js");
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-Brle-yuG.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-BXXMMAzz.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-BdBBnV8v.js");
...
function loadCommandsCoreRuntime() {
	commandsCoreRuntimePromise ??= import("./commands-core.runtime-Bddjmt6U.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-Bosx1Wsd.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-BobkolwG.js");
