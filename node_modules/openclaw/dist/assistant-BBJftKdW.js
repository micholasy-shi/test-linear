...
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-d06YPgrf.js";
...
async function planCrestodianCommandWithConfiguredModel(params) {
	...
	try {
		const parsed = parseCrestodianAssistantPlanText(extractAssistantText(await completeWithPreparedSimpleCompletionModel({
...
async function loadRunCliAgent() {
	return (await import("./cli-runner-lL0zsAo4.js")).runCliAgent;
}
async function loadRunEmbeddedPiAgent() {
	return (await import("./pi-embedded-gtBj9I4K.js")).runEmbeddedPiAgent;
}
