...
import { r as safeRealpathSync } from "./path-safety-CrnL8Kkz.js";
...
import { t as describePluginInstallSource } from "./install-source-info-Dp75vUL7.js";
import { s as resolveInstalledPluginIndexStorePath, t as loadPluginManifestRegistry } from "./manifest-registry-CXpW6f0a.js";
import { a as readJsonFileSync, i as readJsonFile, o as writeJsonAtomic } from "./json-files-C6eUYM9r.js";
import { n as saveJsonFile } from "./json-file-BSeO2P_T.js";
import { n as safeParseWithSchema } from "./zod-parse-BzTcxszB.js";
...
function buildInstalledPluginIndexRecords(params) {
	...
	return params.registry.plugins.map((record) => {
		...
		if (record.syntheticAuthRefs && record.syntheticAuthRefs.length > 0) indexRecord.syntheticAuthRefs = record.syntheticAuthRefs;
...
//#endregion
export { refreshPersistedInstalledPluginIndexSync as a, getCurrentPluginMetadataSnapshotState as c, isInstalledPluginEnabled as d, listInstalledPluginRecords as f, extractPluginInstallRecordsFromInstalledPluginIndex as g, hashJson as h, refreshPersistedInstalledPluginIndex as i, setCurrentPluginMetadataSnapshotState as l, resolveInstalledPluginIndexPolicyHash as m, readPersistedInstalledPluginIndex as n, writePersistedInstalledPluginIndex as o, loadInstalledPluginIndex as p, readPersistedInstalledPluginIndexSync as r, clearCurrentPluginMetadataSnapshotState as s, inspectPersistedInstalledPluginIndex as t, getInstalledPluginRecord as u };
