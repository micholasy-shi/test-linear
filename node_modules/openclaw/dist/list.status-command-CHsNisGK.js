...
import { b as resolveAgentDir, i as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride } from "./agent-scope-i10se9ty.js";
import { $ as shouldEnableShellEnvFallback, X as getShellEnvAppliedKeys, r as createConfigIO } from "./io-CFdEhZuM.js";
...
import { u as resolveAuthStorePathForDisplay } from "./source-check-DsALcHaU.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-D-8DaAtv.js";
import { I as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-CwkNkui5.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-Cvhc4iGK.js";
import { u as isNonSecretApiKeyMarker, v as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-Huk_Auss.js";
import { b as parseModelRef, f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-VQV3de71.js";
...
import { t as resolveAuthProfileDisplayLabel } from "./auth-profiles-BOEvF4Rg.js";
import { n as listProfilesForProvider } from "./profile-list-zV5Cv5VC.js";
import "./profiles-CrHNjqxk.js";
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-BxJGDEXo.js";
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey } from "./model-auth-Bic7ggHC.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-CbfwZExx.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-juR93cKY.js";
import { t as maskApiKey } from "./mask-api-key-Buk1oOE6.js";
import { t as loadModelsConfig } from "./load-config-CYQugdzh.js";
import { n as isRich } from "./list.format-19xtgqOy.js";
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-CHwvJCUp.js");
	return providerUsageRuntimePromise;
}
function loadProgressRuntime() {
	progressRuntimePromise ??= import("./progress-DvLtPNBN.js");
	return progressRuntimePromise;
}
function loadTerminalTableRuntime() {
	terminalTableRuntimePromise ??= import("./table-DdhfWoSx.js");
	return terminalTableRuntimePromise;
}
function loadListProbeRuntime() {
	listProbeRuntimePromise ??= import("./list.probe-DYxLv-ww.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-CkiWKzO2.js");
		runtime.log("");
