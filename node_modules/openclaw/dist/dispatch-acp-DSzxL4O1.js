...
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-diT_CwWC.js";
import { s as hasOutboundReplyContent } from "./reply-payload-Cy4FCQXC.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-DI3gntLU.js";
...
import { r as prefixSystemMessage } from "./system-message-CqLSkwvn.js";
import { t as createTtsDirectiveTextStreamCleaner } from "./directives-CUHtjAI4.js";
import { i as shouldCleanTtsDirectiveText, t as resolveConfiguredTtsMode } from "./tts-config-oqk_y0UD.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-R2sIrq3b.js";
import { t as hasInboundMedia } from "./inbound-media-CZw6TqdX.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-CF9dDeig.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-D0iI_Q3b.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-pF6jmcaN.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-D0Xq9jbe.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-3Vb1kBlr.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-Be9lMXrA.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-CDlck4ti.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-B9_ofpFl.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-1E9TL-5R.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-BgONQS58.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-BnMH179W.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-CDlck4ti.js");
	return dispatchAcpTtsRuntimePromise;
}
function loadDispatchAcpTranscriptRuntime() {
	dispatchAcpTranscriptRuntimePromise ??= import("./dispatch-acp-transcript.runtime-BPsoHlG4.js");
