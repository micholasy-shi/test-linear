...
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-Bwz1b4dr.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CD7VqLWH.js";
import { c as isValidEnvSecretRefId, s as isSecretRef } from "./types.secrets-ClP-vJ-P.js";
...
import { a as findTailscaleBinary } from "./tailscale-DXoBJpcV.js";
...
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-CFdEhZuM.js";
import { l as resolvePluginContributionOwners } from "./plugin-registry-CZ8QXP5l.js";
import { c as listChatChannels } from "./registry-GHcDenJ3.js";
import { t as ConfigMutationConflictError } from "./config--k_1dtUP.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-BcSjfAfb.js";
import { t as randomToken } from "./random-token-C3WrGJIi.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-CZlUBsZA.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-Cn62oyN_.js";
import { t as resolveControlUiLinks } from "./control-ui-links-B5bsAmWy.js";
import { n as ensureAuthProfileStore } from "./store-D-8DaAtv.js";
import "./workspace-Ddypv-c6.js";
import "./auth-profiles-BOEvF4Rg.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-BbfrF7sc.js";
import { n as withProgress } from "./progress-CmC4nq1O.js";
import { t as WizardCancelledError } from "./prompts-CsV4pT5z.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-rocPqVSR.js";
import { t as note$1 } from "./note-B6LXIgud.js";
...
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-D1LplN50.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BxnfkIdw.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-mX5Q_dhT.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-BbZZhd3O.js";
import { n as applyAuthChoice } from "./auth-choice-D-tAymj0.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-CsPO1jbn.js";
import { i as setupChannels } from "./onboard-channels-BjKb3JSy.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-G1v9x6qg.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-Bm-WhoL6.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-8Fp9OtpL.js";
import { t as promptCustomApiConfig } from "./onboard-custom-Cmvyaf25.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-BcohWInW.js";
import { n as formatHealthCheckFailure } from "./health-format-Dba3c-PK.js";
import { n as healthCommand } from "./health-DeX4rMEb.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-DVArlYEZ.js";
import { t as setupSkills } from "./onboard-skills-g3vG7gNY.js";
...
async function resolveProviderChoiceModelAllowlist(params) {
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-CFJ4q9So.js");
...
function loadSetupPluginConfigModule() {
	setupPluginConfigModulePromise ??= import("./setup.plugin-config-BkCuwGhl.js");
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-C07Oc89F.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-V8M12JYU.js");
