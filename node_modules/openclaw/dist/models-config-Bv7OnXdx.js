...
import { i as createConfigRuntimeEnv } from "./state-dir-dotenv-DAjQHBxO.js";
...
import { t as MODEL_APIS } from "./types.models-CEpVE_A8.js";
import "./public-surface-runtime-DpA22A6m.js";
import "./bundled-plugin-metadata-Ds2SxpYG.js";
import { i as getRuntimeConfig, s as projectConfigOntoRuntimeSourceSnapshot } from "./io-CFdEhZuM.js";
import { n as findNormalizedProviderValue, r as normalizeProviderId } from "./provider-id-DRW5WMbW.js";
import { c as getCurrentPluginMetadataSnapshotState, l as setCurrentPluginMetadataSnapshotState, m as resolveInstalledPluginIndexPolicyHash, s as clearCurrentPluginMetadataSnapshotState } from "./installed-plugin-index-store-Bg0YPG9v.js";
import { n as resolveInstalledManifestRegistryIndexFingerprint } from "./manifest-registry-installed-B7YTYcgb.js";
import { s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-DLisEE8Y.js";
import "./config--k_1dtUP.js";
import { n as ensureAuthProfileStore } from "./store-D-8DaAtv.js";
import { d as resolveOwningPluginIdsForProvider } from "./providers-CjE0WvyR.js";
import { A as resolveProviderConfigApiKeyWithPlugin, g as normalizeProviderConfigWithPlugin, r as applyProviderNativeStreamingUsageCompatWithPlugin } from "./provider-runtime-CwkNkui5.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-Cvhc4iGK.js";
import { g as resolveNonEnvSecretRefHeaderValueMarker, h as resolveNonEnvSecretRefApiKeyMarker, m as resolveEnvSecretRefHeaderValueMarker, u as isNonSecretApiKeyMarker } from "./model-auth-markers-Huk_Auss.js";
import { i as runProviderCatalog, n as normalizePluginDiscoveryResult, r as resolveRuntimePluginDiscoveryProviders, t as groupPluginDiscoveryProvidersByOrder } from "./provider-discovery-BWOhr0BX.js";
import { a as normalizeHeaderValues, c as resolveMissingProviderApiKey, i as normalizeConfiguredProviderApiKey, n as createProviderAuthResolver, o as normalizeResolvedEnvApiKey, s as resolveApiKeyFromProfiles, t as createProviderApiKeyResolver } from "./models-config.providers.secrets-BfMn6k2P.js";
import "node:url";
...
function resolvePluginMetadataSnapshotConfigFingerprint(config) {
...
function setCurrentPluginMetadataSnapshot(snapshot, options = {}) {
	setCurrentPluginMetadataSnapshotState(snapshot, snapshot ? resolvePluginMetadataSnapshotConfigFingerprint(options.config) : void 0);
}
...
function resolvePluginMetadataProviderOwners(pluginMetadataSnapshot, provider) {
	...
	appendNormalizedPluginMetadataOwners(owners, pluginMetadataSnapshot.owners.providers, provider, normalizedProvider);
	appendNormalizedPluginMetadataOwners(owners, pluginMetadataSnapshot.owners.cliBackends, provider, normalizedProvider);
...
//#endregion
export { clearCurrentPluginMetadataSnapshot as a, resetModelsJsonReadyCacheForTest as i, ensureOpenClawModelsJson as n, setCurrentPluginMetadataSnapshot as o, writeModelsFileAtomicForModelsJson as r, ensureModelsFileModeForModelsJson as t };
