...
import { a as logWarn, r as logInfo } from "./logger-mz_TsqXj.js";
import { a as isSubagentSessionKey, i as isCronSessionKey, o as parseAgentSessionKey } from "./session-key-utils-naHBWFyS.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-hxP9B3Or.js";
import { Q as resolveShellEnvFallbackTimeoutMs, Z as getShellPathFromLoginShell } from "./io-CFdEhZuM.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-BvG644ke.js";
import { t as killProcessTree } from "./kill-tree-BnvyPovj.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-B32dwK-Q.js";
import { b as EXEC_TOOL_DISPLAY_SUMMARY, x as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-CC72sL8W.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-Bmv0a_G3.js";
import { C as formatExecDeniedUserMessage, T as parseExecApprovalResultText, u as sanitizeUserFacingText, w as isExecDeniedResultText } from "./sanitize-user-facing-text-DgEphtot.js";
import { o as failedTextResult, v as textResult } from "./common-C4RGIxnG.js";
import { t as callGatewayTool } from "./gateway-DY8i5DmM.js";
import { t as splitShellArgs } from "./shell-argv-Z3tzJ95W.js";
import { c as describeInterpreterInlineEval, f as analyzeShellCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, p as buildEnforcedShellCommand } from "./exec-approvals-allowlist-Dyj47wp0.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-B3tlMP8K.js";
import { C as requiresExecApproval, D as resolveExecApprovalsFromFile, E as resolveExecApprovals, _ as normalizeExecTarget, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, f as minSecurity, g as normalizeExecSecurity, l as loadExecApprovals, m as normalizeExecAsk, s as hasDurableExecApproval, u as maxAsk, v as persistAllowAlwaysPatterns, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-BzZbTLG7.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-5h8EWMob.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-BwVg-TdQ.js";
import "./delivery-context-DVl8q3EW.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-1XVo5mVb.js";
...
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-E2axr0Qp.js";
import { f as resolveExecApprovalInitiatingSurfaceState, s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-B6LWxNYR.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-CIzK0-K_.js";
import { t as getProcessSupervisor } from "./supervisor-BdAyp6Dn.js";
import { C as setJobTtlMs, S as markExited, _ as getFinishedSession, a as DEFAULT_PENDING_MAX_OUTPUT, b as listRunningSessions, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as drainSession, h as deleteSession, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as getSession, w as tail, x as markBackgrounded, y as listFinishedSessions } from "./bash-tools.exec-runtime-omWiLrNq.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-Cx_NKhFN.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-BtyF2vio.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-DXCRmyyO.js";
...
async function loadFsSafeModule() {
	fsSafeModulePromise ??= import("./fs-safe-sV0LG2ru.js");
