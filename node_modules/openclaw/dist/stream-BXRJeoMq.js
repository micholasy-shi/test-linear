import { o as createPayloadPatchStreamWrapper } from "./provider-stream-shared-C_b_e9Jg.js";
...
function ensureVeniceDeepSeekV4Replay(payload) {
	...
	for (const message of payload.messages) {
		...
		if (record.role === "assistant" && Array.isArray(record.tool_calls)) record.reasoning_content ??= "";
	}
}
