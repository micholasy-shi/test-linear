...
import { o as getResolvedLoggerSettings } from "./logger-BYIbL3gn.js";
import { t as danger } from "./globals-CJu56k75.js";
...
import { t as listPluginContributionIds, v as loadPluginRegistrySnapshot } from "./plugin-registry-CZ8QXP5l.js";
import { o as normalizeChannelId } from "./registry-GHcDenJ3.js";
import { i as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-yTN80EXi.js";
import { r as replaceConfigFile } from "./config--k_1dtUP.js";
import "./plugins-D-K4uCVI.js";
import "./logging-D6k9oiB3.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-BXJT49qh.js";
import { t as listReadOnlyChannelPluginsForConfig } from "./read-only-DoF9vWKk.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-DacXri_3.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CWjxgWew.js";
...
import { t as parseLogLine } from "./parse-log-line-7MBNWJOB.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-BlDYA0O5.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-BJ4CAmat.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-sI3iozPv.js";
import { t as channelsListCommand } from "./list-DCEc2ccg.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-BbfyaLbn.js";
...
function loadChannelSetupPluginInstall() {
	channelSetupPluginInstallPromise ??= import("./plugin-install-BZU6khGx.js");
	return channelSetupPluginInstallPromise;
}
function loadOnboardChannels() {
	onboardChannelsPromise ??= import("./onboard-channels-Z30z-EXq.js");
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	const { listChannelPluginCatalogEntries } = await import("./catalog-DNZbOzkA.js");
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-B_bk3lrl.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-B48qkt74.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-CyulEQqT.js");
