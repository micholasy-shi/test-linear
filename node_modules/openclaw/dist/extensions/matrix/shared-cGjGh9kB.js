...
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-DBfNTyCf.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-lS0LIYJD.js").then((n) => n.n).then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
