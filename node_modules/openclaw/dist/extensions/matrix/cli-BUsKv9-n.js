...
import { n as matrixSetupAdapter } from "./setup-core-vUjse8DF.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-DCSlgaaM.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-BwMA7mvv.js";
import { n as withResolvedActionClient } from "./client-DVdViAvL.js";
import { r as resolveMatrixAuthContext } from "./config-DBfNTyCf.js";
import "./client-D4YJSvdM.js";
import { i as formatZonedTimestamp } from "./runtime-api-QZ4K8OIp.js";
import { isOpenClawManagedMatrixDevice, summarizeMatrixDeviceHealth } from "./device-health-CBpA1E9B.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-C1NC8Xcc.js";
import { a as confirmMatrixVerificationSas, b as verifyMatrixRecoveryKey, c as getMatrixRoomKeyBackupStatus, d as listMatrixVerifications, f as mismatchMatrixVerificationSas, g as runMatrixSelfVerification, h as restoreMatrixRoomKeyBackup, l as getMatrixVerificationSas, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, p as requestMatrixVerification, r as cancelMatrixVerification, t as acceptMatrixVerification, u as getMatrixVerificationStatus, v as startMatrixVerification } from "./verification-ChEDFxLb.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-DVdViAvL.js").then((n) => n.t);
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-1MYIBPbO.js");
