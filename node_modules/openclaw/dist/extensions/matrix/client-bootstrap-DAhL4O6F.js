...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-D4YJSvdM.js").then((n) => n.t), import("./shared-cGjGh9kB.js").then((n) => n.a)]).then(([clientModule, sharedModule]) => ({
