...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-C2Gj7ZHs.js";
import "./config-DBfNTyCf.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-D1tWByPp.js").then((n) => n.n), import("./logging-BwMA7mvv.js").then((n) => n.n)]).then(([sdkModule, loggingModule]) => ({
