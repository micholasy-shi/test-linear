...
import { n as parseDiscordTarget } from "./chunk-DJnW9dLI.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-DQsxlfst.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-LD6bfsUv.js";
import { t as getDiscordApprovalCapability } from "./approval-native-Da0LHcTv.js";
import { t as discordMessageActions$1 } from "./channel-actions-BXRAdrb3.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-P05NPRno.js";
...
import { i as normalizeDiscordMessagingTarget, n as discordOutbound, r as looksLikeDiscordTargetId } from "./outbound-adapter-dmgRi1Sw.js";
import { t as getDiscordRuntime } from "./runtime-DwbCVZGx.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-BvWsvKwd.js";
...
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-B1hSb-ko.js").then((n) => n.a));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-DjcX7dpu.js");
...
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-8HtLgtII.js").then((n) => n.n);
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-BNcAwSBC.js").then((n) => n.t);
