...
import { i as formatWhatsAppWebAuthStatusState, m as readWebAuthState } from "./auth-store-Da7U_n_T.js";
...
async function finalizeWhatsAppSetup(params) {
	...
	if (await params.prompter.confirm({
		...
		const { loginWeb } = await import("./login-D-9V0MWK.js").then((n) => n.n);
