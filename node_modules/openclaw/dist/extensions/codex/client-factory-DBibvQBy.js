...
const defaultCodexAppServerClientFactory = (startOptions, authProfileId) => import("./shared-client-MLSTUxlJ.js").then((n) => n.r).then(({ getSharedCodexAppServerClient }) => getSharedCodexAppServerClient({
	startOptions,
	authProfileId
}));
