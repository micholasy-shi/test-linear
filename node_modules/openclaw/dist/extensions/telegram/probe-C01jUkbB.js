...
import { M as isTelegramPollingNetworkError, k as isRecoverableTelegramNetworkError } from "./send-PMS8bE6c.js";
...
async function loadTelegramActionRuntime() {
	telegramActionRuntimePromise ??= import("./action-runtime-BMhciUj7.js");
...
async function loadTelegramMonitorPollingRuntime() {
	telegramMonitorPollingRuntimePromise ??= import("./monitor-polling.runtime-Dio0wgTp.js");
...
async function loadTelegramMonitorWebhookRuntime() {
	telegramMonitorWebhookRuntimePromise ??= import("./monitor-webhook.runtime-Dm1PGZFc.js");
