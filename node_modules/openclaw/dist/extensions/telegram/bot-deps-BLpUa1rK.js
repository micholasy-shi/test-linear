...
import { A as isSafeToRetrySendError, C as withTelegramApiErrorLogging, _ as wasSentByBot, a as editMessageTelegram, j as isTelegramClientRejection, z as buildTelegramThreadParams } from "./send-PMS8bE6c.js";
import { r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-DA0b2Fs4.js";
import { n as deliverReplies, r as emitInternalMessageSentHook } from "./delivery-BmuKO0Rm.js";
...
function createTelegramDraftStream(params) {
	...
	const clear = async () => {
		...
		if (previewTransport !== "draft" || resolvedDraftApi == null || streamDraftId == null) return;
