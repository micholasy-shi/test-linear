...
import { $ as buildSenderName, A as isSafeToRetrySendError, B as buildTypingThreadParams, C as withTelegramApiErrorLogging, D as renderTelegramHtmlText, F as buildTelegramGroupFrom, G as resolveTelegramForumFlag, H as extractTelegramForumFlag, I as buildTelegramGroupPeerId, J as resolveTelegramReplyId, K as resolveTelegramForumThreadId, L as buildTelegramParentPeer, N as tagTelegramNetworkError, P as buildGroupLabel, Q as buildSenderLabel, R as buildTelegramRoutingTarget, V as describeReplyTarget, W as resolveTelegramDirectPeerId, X as resolveTelegramThreadSpec, Y as resolveTelegramStreamMode, Z as withResolvedTelegramForumFlag, a as editMessageTelegram, at as normalizeForwardedContext, ct as firstDefined, dt as normalizeDmAllowFromWithStore, et as expandTextLinks, ft as resolveSenderAllowMatch, g as recordSentMessage, j as isTelegramClientRejection, k as isRecoverableTelegramNetworkError, lt as isSenderAllowed, nt as getTelegramTextParts, q as resolveTelegramGroupAllowFromContext, rt as hasBotMention, st as resolveTelegramPrimaryMedia, tt as extractTelegramLocation, ut as normalizeAllowFrom, x as buildInlineKeyboard, z as buildTelegramThreadParams } from "./send-PMS8bE6c.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-DaXEabc2.js";
...
import { t as createTelegramThreadBindingManager } from "./thread-bindings-DAvCCNTH.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-DbKGqpw-.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-DnMNz9KB.js";
import { a as buildCappedTelegramMenuCommands, i as createTelegramDraftStream, n as defaultTelegramBotDeps, o as buildPluginTelegramMenuCommands, r as resolveTelegramExecApproval, s as syncTelegramMenuCommands } from "./bot-deps-BLpUa1rK.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-BmuKO0Rm.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-PMS8bE6c.js").then((n) => n.p);
...
async function loadTelegramNativeCommandDeliveryRuntime() {
	telegramNativeCommandDeliveryRuntimePromise ??= import("./bot-native-commands.delivery.runtime-BSTQshMg.js");
...
async function loadTelegramMessageContextSessionRuntime(runtime) {
	...
	return {
		...await import("./bot-message-context.session.runtime-D4_5vcRV.js"),
		...runtime
	};
}
...
async function loadTelegramMessageContextRuntime() {
	telegramMessageContextRuntimePromise ??= import("./bot-message-context.runtime-BY6FQLtV.js");
...
function createLaneTextDeliverer(params) {
	...
	const isMessagePreviewLane = (lane) => !isDraftPreviewLane(lane);
	...
	const canMaterializeDraftFinal = (lane, previewButtons) => {
		...
		return lane.hasStreamedMessage && isDraftPreviewLane(lane) && !hasPreviewButtons && typeof lane.stream?.materialize === "function";
	};
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-BLpUa1rK.js").then((n) => n.t)).defaultTelegramBotDeps;
