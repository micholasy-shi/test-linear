...
import { a as qqbotSetupAdapterShared, i as qqbotMeta, n as qqbotSetupWizard, r as qqbotConfigAdapter, t as qqbotChannelConfigSchema } from "./config-schema-CNFblbtP.js";
import { n as writeOpenClawConfigThroughRuntime, t as toGatewayAccount } from "./narrowing-BoieBTIU.js";
import { t as getQQBotRuntime } from "./runtime-DfUSfqc5.js";
import { l as getQQBotDataPath, n as normalizeTarget, t as looksLikeQQBotTarget } from "./target-parser-CqH_T7ny.js";
	...
	return createChannelApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => {
				...
				return (await import("./handler-runtime-D2jR4lcP.js")).qqbotApprovalNativeRuntime;
			}
		})
	});
}
...
function loadGatewayModule() {
	_gatewayModulePromise ??= import("./gateway-DiMFvBZT.js");
...
const qqbotPlugin = {
	...
	outbound: {
		...
		sendText: async ({ to, text, accountId, replyToId, cfg }) => {
			...
			const { sendText } = await import("./outbound-Bf1CsgyS.js").then((n) => n.t);
		...
		sendMedia: async ({ to, text, mediaUrl, accountId, replyToId, cfg }) => {
			await loadGatewayModule();
			const account = resolveQQBotAccount(cfg, accountId);
			const { sendMedia } = await import("./outbound-Bf1CsgyS.js").then((n) => n.t);
