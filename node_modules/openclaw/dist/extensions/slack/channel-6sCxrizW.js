...
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-mR-bIybV.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-cPgYiOeF.js")).slackApprovalNativeRuntime
	})
});
...
async function loadSlackActionRuntime$1() {
	slackActionRuntimePromise$1 ??= import("./action-runtime.runtime-BuIzCezM.js");
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-gIq7RpbK.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-K8us8C85.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-wnwaJcGr.js").then((n) => n.t));
...
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime-BuIzCezM.js");
...
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-ZqtVsCdK.js").then((n) => n.t);
